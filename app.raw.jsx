        ...
        const App = () => {
            ...
            const meikoLogo = "https://rain-galley-248.notion.site/image/attachment%3A1a4404e1-e6b1-4f29-a495-123224c6135a%3AMeiko_logo.png?table=block&id=2c04c228-35e5-80d2-b534-f270fb01613d&spaceId=cf48a189-fd68-4fe6-a35c-bf6538001b35&width=770&userId=&cache=v2";
            const notebookLMLogo = "https://raw.githubusercontent.com/meikochang/my-web-assets/refs/heads/main/images/notebooklm.png";
                            ...
                            <div className="flex flex-row justify-between items-start gap-4">
                                <div className="flex flex-col items-start justify-center min-w-0">
                                    ...
                                    <div className="mt-4 flex items-center gap-3">
                                        <img src={meikoLogo} alt="Meiko Logo" className="w-8 h-8 rounded-full border-2 border-slate-600 shadow-sm flex-shrink-0" />
                                                ...
                                                return (
                                                    <button key={d.id} onClick={() => handleStyleSelection(d.id)} className={`text-left rounded-xl overflow-hidden border-2 transition-all group ${selectedStyle === d.id ? 'border-pink-300 shadow-[0_0_15px_rgba(249,168,212,0.3)]' : 'border-slate-700 hover:border-slate-500'}`}>
                                                        <div className="aspect-video bg-slate-950/60 overflow-hidden relative">
                                                            {thumb && <img src={thumb.replace('sz=w800', 'sz=w400')} loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt={d.title} />}
                                                ...
                                                <div className="w-full md:w-36 lg:w-40 flex-shrink-0 relative">
                                                    <div className="flex flex-row md:flex-col gap-3 overflow-x-auto md:overflow-y-auto custom-scrollbar md:pr-2 py-1 md:absolute md:inset-0 h-[100px] md:h-auto">
                                                        {currentExample.slides.map((slide, idx) => (
                                                            ...
                                                            >
                                                                <img src={slide.replace('sz=w800', 'sz=w200')} loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt={`Thumbnail ${idx+1}`} />
