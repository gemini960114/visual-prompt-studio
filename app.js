...
const Icon = ({
  ...
  const icons = {
    ...
    Share2: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
      cx: "18",
      cy: "5",
      r: "3"
    ...
    GitCommit: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
      cx: "12",
      cy: "12",
      r: "4"
    }), /*#__PURE__*/React.createElement("line", {
    ...
    Triangle: /*#__PURE__*/React.createElement("path", {
      d: "M13.73 21a2 2 0 0 1-3.46 0L1.73 6A2 2 0 0 1 3.46 3h17.08a2 2 0 0 1 1.73 3l-8.54 15z"
    }),
    ...
    Projector: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
      d: "M5 7 3 21"
    }), /*#__PURE__*/React.createElement("path", {
      d: "m19 7 2 14"
    }), /*#__PURE__*/React.createElement("path", {
...
const HighlightedText = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, parts.map((part, i) => {
    if (!part) return null;
...
const palettePresets = [{
  id: 'pal-as',
  name: 'AS 配色',
  colors: ['#0D5689', '#9FC6BC', '#E8CECC', '#F8E8D4', '#6B7D8D']
}, {
  id: 'pal-e01',
  name: '紫羅蘭夢境與珊瑚',
  colors: ['#E6E1EC', '#A6A4B4', '#9FBFDD', '#DA8889', '#5C506B']
}, {
  id: 'pal-e02',
  name: '晨霧玫瑰與深海',
  colors: ['#F5D6D6', '#E8ECF1', '#8EACA9', '#6A7B83', '#B59AAA']
}, {
  id: 'pal-e03',
  name: '質樸暖沙與青藍',
  colors: ['#F6F3EB', '#D7DFE2', '#9FB0B8', '#78929C', '#B89A78']
}, {
  id: 'pal-e04',
  name: '日落琥珀與陶土',
  colors: ['#F7F5F0', '#F5D29C', '#E3A87C', '#B58376', '#7D5B52']
}, {
  id: 'pal-e05',
  name: '薰衣草與薄荷微風',
  colors: ['#A4A6C4', '#C3D2C4', '#FAF6E9', '#EAD6D8', '#718096']
}, {
  id: 'pal-e06',
  name: '醇厚紅茶與灰褐',
  colors: ['#FAF6F5', '#A14F48', '#8A786F', '#4A413D', '#D3B29F']
}, {
  id: 'pal-e07',
  name: '櫻花暮色與靛藍',
  colors: ['#FBEFF2', '#A19EBF', '#6E85B2', '#3A4B7C', '#D6A5B1']
}, {
  id: 'pal-e08',
  name: '靜謐夜空與極光',
  colors: ['#0C1821', '#1B3B6F', '#21A179', '#93E1D8', '#D8C17A']
}, {
  id: 'pal-01',
  name: '企業藍 Corporate Blue',
  colors: ['#16324F', '#2E6F95', '#F2A900', '#A9D6E5', '#8B5E34']
}, {
  id: 'pal-02',
  name: '沉穩黑金 Black & Gold',
  colors: ['#171717', '#4A5568', '#D4A72C', '#E8DDB5', '#7B5E2E']
}, {
  id: 'pal-03',
  name: '科技紫 Tech Purple',
  colors: ['#34205C', '#6C4AB6', '#19B5A5', '#D8C9F2', '#E09F3E']
}, {
  id: 'pal-04',
  name: '森林綠 Forest Green',
  colors: ['#1F4D3A', '#4D8061', '#D98E32', '#CFE3D4', '#7A5C43']
}, {
  id: 'pal-05',
  name: '活力橘 Vibrant Orange',
  colors: ['#8F3B1B', '#F2762E', '#177E89', '#FFD2A6', '#5C4B8A']
}, {
  id: 'pal-06',
  name: '莫蘭迪 Morandi',
  colors: ['#22223B', '#4A4E69', '#9A8C98', '#C9ADA7', '#6B705C']
}, {
  id: 'pal-07',
  name: '海洋藍綠 Ocean Teal',
  colors: ['#123B5D', '#078C91', '#F4B942', '#A9E1D7', '#D36B4B']
}, {
  id: 'pal-08',
  name: '熱情紅 Passion Red',
  colors: ['#8E2635', '#D94B4B', '#F0A202', '#F3C6C8', '#6B4E71']
}, {
  id: 'pal-09',
  name: '現代中性 Modern Neutral',
  colors: ['#27313A', '#66717E', '#C77938', '#D8DDE2', '#8A9A5B']
}, {
  id: 'pal-10',
  name: '大地棕 Earth Tone',
  colors: ['#5A4438', '#9A6B4F', '#6F826A', '#DFC6A8', '#4F6D7A']
}, {
  id: 'pal-11',
  name: '粉彩夢幻 Pastel Dream',
  colors: ['#DB7093', '#F9A8D4', '#C4B5FD', '#93C5FD', '#6D7FC7']
}, {
  id: 'pal-12',
  name: '日落活力 Sunset Energy',
  colors: ['#44305E', '#D95D73', '#F2A541', '#F7C9A9', '#5B8E7D']
}, {
  id: 'pal-13',
  name: '沉穩海軍藍金 Navy & Champagne',
  colors: ['#FFFFFF', '#17365D', '#C5A253', '#AFCBE3', '#E7B486']
}, {
  id: 'pal-14',
  name: '正式酒紅石墨 Burgundy & Graphite',
  colors: ['#F7F4EF', '#702F3B', '#343A40', '#B9A58C', '#8393A7']
}, {
  id: 'pal-15',
  name: '正式墨綠古銅 Emerald & Bronze',
  colors: ['#F4F1E8', '#183F35', '#4F6B62', '#A8834F', '#B9C8C2']
}, {
  id: 'pal-16',
  name: '馬卡龍晴日 Macaron Daylight',
  colors: ['#F8D7DA', '#FBE5B6', '#CDE8D5', '#CFE3F4', '#DCD4F2']
}, {
  id: 'pal-17',
  name: '馬卡龍甜霧 Macaron Mist',
  colors: ['#E8C7CF', '#F2D2B6', '#D8E2C4', '#BED7DF', '#D6CEE5']
}, {
  id: 'pal-18',
  name: '低彩度城市霧 Muted City',
  colors: ['#E7E3DC', '#A8B0B6', '#74828B', '#9EAAA0', '#B89E91']
}, {
  id: 'pal-19',
  name: '低彩度藍灰陶土 Muted Blue & Clay',
  colors: ['#E9ECEB', '#AABBC4', '#718793', '#C2A398', '#91877E']
}];
...
const ColorPicker = ({
  ...
  const rgbR = clampByte(rgb.r),
    rgbG = clampByte(rgb.g),
    rgbB = clampByte(rgb.b);
  ...
  React.useEffect(() => {
    const move = e => {
      if (dragRef.current) pickFromEvent(e);
    };
    const up = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, supportsEyeDropper && /*#__PURE__*/React.createElement("button", {
    onClick: pickFromScreen,
    title: pickLabel || '滴管取色',
    className: "w-8 h-8 rounded-md border border-slate-600 bg-slate-800 hover:bg-slate-700 hover:border-pink-300 text-slate-300 hover:text-pink-300 flex items-center justify-center flex-shrink-0 transition-colors"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Pipette",
    size: 16
  })), /*#__PURE__*/React.createElement("div", {
    className: "w-8 h-8 rounded-md border border-slate-600 flex-shrink-0",
    style: {
      backgroundColor: hex
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: lblCls
  }, "HEX (16\u9032\u4F4D)")), /*#__PURE__*/React.createElement("div", {
    ...
    max: "255",
    value: rgbR,
    onChange: e => setFromRgb(e.target.value, rgbG, rgbB),
    className: inputCls
  }), /*#__PURE__*/React.createElement("div", {
    className: lblCls
  }, "R")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    max: "255",
    value: rgbG,
    onChange: e => setFromRgb(rgbR, e.target.value, rgbB),
    className: inputCls
  }), /*#__PURE__*/React.createElement("div", {
    className: lblCls
  }, "G")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    max: "255",
    value: rgbB,
    onChange: e => setFromRgb(rgbR, rgbG, e.target.value),
    className: inputCls
  }), /*#__PURE__*/React.createElement("div", {
    className: lblCls
  }, "B"))), onClose && /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    className: "w-full mt-2 py-1.5 bg-pink-300 hover:bg-pink-400 text-slate-900 text-xs font-bold rounded-md transition-colors"
  }, doneLabel || '完成'));
};
const CheckCircle = ({
  selected,
...
const referenceData = [{
  ...
  examples: [{
    name: '範例 1｜北歐極簡商務風',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1ydehFZqCwgrPhncaF06xTeMTFmkkMWv8&sz=w800', 'https://drive.google.com/thumbnail?id=12UR0QIiV5fLFNjDQBq9AEvvKVgRfUnL3&sz=w800', 'https://drive.google.com/thumbnail?id=1QDJu1V6oyITaFwXaY2PPCpfkWZT12T9W&sz=w800', 'https://drive.google.com/thumbnail?id=1vQl6QlEdmeF5efu9CXHmtycxl4xe1MoD&sz=w800', 'https://drive.google.com/thumbnail?id=1c1IyC8Bal_yzqrz6jnq9KKQL-Em4GpA6&sz=w800', 'https://drive.google.com/thumbnail?id=1luAPpr4gpxHed_IPNBDU4GQeAnh0RMhQ&sz=w800', 'https://drive.google.com/thumbnail?id=1jh4xDOzRP_ZjPuhXFXNKuDjbw9ViQ2NN&sz=w800', 'https://drive.google.com/thumbnail?id=1o2ezYeD1hXUjEc4NFb7KlBwcLDL_fkVe&sz=w800', 'https://drive.google.com/thumbnail?id=1KKnghsu148Rncu2_UM0lvR4RA7NhpFUJ&sz=w800', 'https://drive.google.com/thumbnail?id=1ctgqfpw8B2x_9c036yYmeB_3hjGim1YL&sz=w800', 'https://drive.google.com/thumbnail?id=1cafGYsDYtAjsZh6stmWrIWqJDcSppkuB&sz=w800', 'https://drive.google.com/thumbnail?id=1RTAPoGZaiq-GN2p3OqWMaiIEJLRrEQyR&sz=w800', 'https://drive.google.com/thumbnail?id=1_wXemlr3B-2fov_roawttZLY5fTjIQlR&sz=w800', 'https://drive.google.com/thumbnail?id=1H5wLeZuuJl2Lrk3MoYJJJ6Q93wE5H50i&sz=w800']
  }]
}, {
  id: 'ref-016',
  icon: 'TrendingUp',
  ...
  examples: [{
    name: '範例 1｜高階商務財經簡報',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1Y7Vw3Ga4SXml5KqHzidHdsnK8EonvIAF&sz=w800', 'https://drive.google.com/thumbnail?id=1Xox8zE7IAE8lG1FxL6ySQdZnxvYitMIs&sz=w800', 'https://drive.google.com/thumbnail?id=1bRpDs3GleliYe-ss0kuL8EQq-FQkvXE1&sz=w800', 'https://drive.google.com/thumbnail?id=1lej1p08uiUtY0701gWBXUMhDvDu6jj0z&sz=w800', 'https://drive.google.com/thumbnail?id=1421uLti6QwNv574jObFPCMatQzw5zpXT&sz=w800', 'https://drive.google.com/thumbnail?id=1w3rA3kXWozu6dso1t8pb1v_gmjl2qHkt&sz=w800', 'https://drive.google.com/thumbnail?id=1m4gzdhpgpV7BX3ZIOO3yuHWaWufV9CIF&sz=w800', 'https://drive.google.com/thumbnail?id=1G9eQ5h-0xKf1G70Eb9R893omzxO77uf_&sz=w800']
  }]
}, {
  id: 'ref-0',
  icon: 'Smile',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1UwzSEcjTcZuU4oICNgeJu4kYviARvznt&sz=w800', 'https://drive.google.com/thumbnail?id=17wH-ppIZfdoszRr_iL0i_Iw8UU5Ry19B&sz=w800', 'https://drive.google.com/thumbnail?id=1E0UL5vkUcERYzUokAJyp4wjekLc-JVXx&sz=w800', 'https://drive.google.com/thumbnail?id=1NNSIPe3xmoNXFS1A7ug6NxAqMee2-hx8&sz=w800', 'https://drive.google.com/thumbnail?id=1U3Xwj8BkLZtv5yDzGAe2d4vSTIXQOAFc&sz=w800', 'https://drive.google.com/thumbnail?id=1tiUhc2yA5ymnHcfDmfmDlss502Xdr0nY&sz=w800', 'https://drive.google.com/thumbnail?id=1HkINj8o5eIQd5zPeaRsqc1_D398HxRjB&sz=w800', 'https://drive.google.com/thumbnail?id=1uxUL4V6UdynOfjEbls7G7qXwxuHPEpst&sz=w800', 'https://drive.google.com/thumbnail?id=1xyr-dANuP7OjAgXmUyLWTlHBWO_6NLuC&sz=w800']
  }]
}, {
  id: 'ref-001',
  icon: 'Monitor',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1yGvx4-svLR3LMU4d1fOQE5WAVIMCZgea&sz=w800', 'https://drive.google.com/thumbnail?id=15SAMztCLoiz2n73DE6SueDNhvcAtixbn&sz=w800', 'https://drive.google.com/thumbnail?id=1y8F42UDBYtk-GChwgZ8LMEPokActZUth&sz=w800', 'https://drive.google.com/thumbnail?id=1XPB9LfUtrKEafjmGY7EwPidipwx6mBZp&sz=w800', 'https://drive.google.com/thumbnail?id=1gGheWMRadn3Xfr5tyuQ9fvyDSmj9mbKy&sz=w800', 'https://drive.google.com/thumbnail?id=1E_6CaqvH38iW_sEJNMojcIc0SqS_vkJb&sz=w800', 'https://drive.google.com/thumbnail?id=1l2fH9XUo1SCVDO7lKPmDQtXKC-hgEF0R&sz=w800', 'https://drive.google.com/thumbnail?id=11hlcaWlRaGQEUOC5uLAF5daT7fmdVqsy&sz=w800', 'https://drive.google.com/thumbnail?id=1br-sdnwvMUzbZXhaR2I9GN5A4cJge0eu&sz=w800', 'https://drive.google.com/thumbnail?id=1YC0OR22Qbu6McSmgZ82gUIPbYZF1rYfq&sz=w800']
  }]
}, {
  id: 'ref-002',
  icon: 'Sparkles',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1mF5Bjxt7aHT9qS04xT8xHib7FbPMkvv-&sz=w800', 'https://drive.google.com/thumbnail?id=1fJwlOPXFTvd_S8UxowllsEdh6YjpjR_n&sz=w800', 'https://drive.google.com/thumbnail?id=1a4-vYvwPJGtccs_GOJkm_R1BLu3Gs-VK&sz=w800', 'https://drive.google.com/thumbnail?id=16QdRtxfR3SrklQjnR-fGk3Qbeinbgl1Z&sz=w800', 'https://drive.google.com/thumbnail?id=1M7HKNq1jq6doacfkn8qhmk_zsZWi6-yN&sz=w800', 'https://drive.google.com/thumbnail?id=1xKNl-bj_0itro3sbAXinu5pVCYtZKJyl&sz=w800', 'https://drive.google.com/thumbnail?id=1jM8wulikbe_Rba0w3XZpkdTni7HmD47f&sz=w800', 'https://drive.google.com/thumbnail?id=1Iii4qhfMdCiIp6djlxtIUw2BKK57IkXu&sz=w800', 'https://drive.google.com/thumbnail?id=1F-YONOIG-efN3MsbhROqqcWyhWPP9ZxO&sz=w800', 'https://drive.google.com/thumbnail?id=1gPFnGFQRLet2lv2QEH6EkVoO6j4kOsIF&sz=w800', 'https://drive.google.com/thumbnail?id=1UA77JEfLRVH-IhZ-WYd5XIygGVAu--uC&sz=w800', 'https://drive.google.com/thumbnail?id=1CB3ez0VgdN13K0-RrlZYCf4aleF6W3bk&sz=w800']
  }, {
    name: '範例 2',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=19leDpP-FyrwYxo2rysQi1V0kd5R5BdUO&sz=w800', 'https://drive.google.com/thumbnail?id=1KLJynU3DWgNV2zSacbx5jGhgyA_9P7LW&sz=w800', 'https://drive.google.com/thumbnail?id=1CY3_i16b_tnETL6GNgzsfxnT3uuxH7Ve&sz=w800', 'https://drive.google.com/thumbnail?id=1OVONflthfL4n5bbv_j_Cdu6xPCPc2OfU&sz=w800', 'https://drive.google.com/thumbnail?id=1hOcMjORVGJtMDltAYokpgV1nok9s6ghg&sz=w800', 'https://drive.google.com/thumbnail?id=1MPgAa73ZLItTfJl8wsQ6k00EYIRXLlr8&sz=w800', 'https://drive.google.com/thumbnail?id=1LhK4mFylgXXsbm8AdQZYNKQ6WgRUdcPn&sz=w800', 'https://drive.google.com/thumbnail?id=15_SN1Wt1678oKrEeag2S0U07ws0KnRsP&sz=w800', 'https://drive.google.com/thumbnail?id=1ZeBn5jfNlkF-EAddaOtdPwXpfv_uAmX4&sz=w800', 'https://drive.google.com/thumbnail?id=1cF_M88Q0QcpHxCfTUJffeOGbO4z1PBt2&sz=w800', 'https://drive.google.com/thumbnail?id=1C9e3eZuN4HnBpV9ah9nVRKvAOjXC8JqH&sz=w800']
  }, {
    name: '範例 3',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1rI2CP5jNkjRjNkojmOCRlMpErDSwu7Hk&sz=w800', 'https://drive.google.com/thumbnail?id=1tgySl-WhPAo-IJxuvAHwDNvNtCCIkiPA&sz=w800', 'https://drive.google.com/thumbnail?id=1K_d3J_IT1YCKMQHSHssQn0-H_gSZZdci&sz=w800', 'https://drive.google.com/thumbnail?id=1VTdZoTe2rgi4DrYxdXVTv9kb4GwIteX2&sz=w800', 'https://drive.google.com/thumbnail?id=1_1MYph0MfhLB5_HR3v1uCLlnDcrZjCBL&sz=w800', 'https://drive.google.com/thumbnail?id=1S4TbvT8QOObQ-nICxXgsRgOcUbsg-cxl&sz=w800', 'https://drive.google.com/thumbnail?id=1eX7r2LoAaHcSUjl5QPdoe89YnzQhDuur&sz=w800', 'https://drive.google.com/thumbnail?id=1KdfYtLEzeljmpmKU-t4s0Jw1ZfRtHXMl&sz=w800', 'https://drive.google.com/thumbnail?id=1Zm7XnUb4YnneaRnwJEBmC1QvWOn84XSk&sz=w800', 'https://drive.google.com/thumbnail?id=1gr2-SG-EsFLl56OkHNYg_YDdyixFfCVl&sz=w800', 'https://drive.google.com/thumbnail?id=1Qg8k0gozlHkTblBbZeB2okrBV7_ntyMr&sz=w800', 'https://drive.google.com/thumbnail?id=12G6VD6OsTcJ4zoKtkKzLqEti3zgK-RMQ&sz=w800', 'https://drive.google.com/thumbnail?id=1zHF7EoKpQJwOEQZY3_AzcgzaLLEvBkoh&sz=w800', 'https://drive.google.com/thumbnail?id=1UX6TJbKdJyX3zWwyXEZgHBLGx8bT-bCH&sz=w800', 'https://drive.google.com/thumbnail?id=1V_cQt-wIo1t73rijdM5a-_jk7Y8hP5a2&sz=w800']
  }, {
    name: '範例 4',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1ye9jO1o_ayNtqqP7t5Yv5YWLZGG7W689&sz=w800', 'https://drive.google.com/thumbnail?id=10YPRBu5XTijgw4w5EnSlq3CYCsAJBLv_&sz=w800', 'https://drive.google.com/thumbnail?id=1aJ5WgeuaCYXocxstEarJLunrhtXf_7ZL&sz=w800', 'https://drive.google.com/thumbnail?id=1cAeRj_sjvyE6Nj97HRrvHFy2vqPpSZk7&sz=w800', 'https://drive.google.com/thumbnail?id=1chiN9troQasEQCJbA26YncIYIliFtuB1&sz=w800', 'https://drive.google.com/thumbnail?id=1MamvVMVX3ioFRtoap9ZJRGaz6EDE2YVB&sz=w800', 'https://drive.google.com/thumbnail?id=1IeziADK77ON4MAv_wL8Fc_YHpJluVinP&sz=w800', 'https://drive.google.com/thumbnail?id=1xf1FUf3YhejCB4ADAhWfwXSwknzlEGnR&sz=w800', 'https://drive.google.com/thumbnail?id=1SJ9C4oQHW_0SeR0vxUZ4pE_iKUkGGqJf&sz=w800', 'https://drive.google.com/thumbnail?id=1aFx4WzQhpDNkHQ0RjtAPYrr1-n18W8Ng&sz=w800', 'https://drive.google.com/thumbnail?id=1aFTcsfsE05_TSZLyLYMUFdLWfnpPuaIU&sz=w800', 'https://drive.google.com/thumbnail?id=1XBjhXwv7Xt2aqa5Q39KK0v2_CwXH_rCe&sz=w800', 'https://drive.google.com/thumbnail?id=1pqmjlLsu8myyh-4Wk1A9oWxwhSkrh8O_&sz=w800', 'https://drive.google.com/thumbnail?id=1_hlHuktReT2twfWRphEdELYUg71ZhaJp&sz=w800']
  }]
}, {
  id: 'ref-006',
  icon: 'Layout',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1VDJHOw8VZcfK4_BtjAPCMKmkjhfyh09t&sz=w800', 'https://drive.google.com/thumbnail?id=13QYi5TFCX-arM_pu5UlJ3X_jCeUOsdr1&sz=w800', 'https://drive.google.com/thumbnail?id=1HdY2eZPBupUBm3l_4TuE8J_-fzERtW1o&sz=w800', 'https://drive.google.com/thumbnail?id=1rOHfP_qfDe5BO7TOz6ZDTZTXXQ80mM2w&sz=w800', 'https://drive.google.com/thumbnail?id=1-2asNoKyY_GSnb_pPVurOlkM3RK_RDAt&sz=w800', 'https://drive.google.com/thumbnail?id=1MgXYGveCBrVO7kll-zipjQSUq9C2yxg3&sz=w800', 'https://drive.google.com/thumbnail?id=1c3VGIUtoun9gkFU_9xWBb--qNaSyyuB_&sz=w800', 'https://drive.google.com/thumbnail?id=1cf-LGGfJzOvk3o4jArWtf5gt4XEjleBJ&sz=w800', 'https://drive.google.com/thumbnail?id=18cOwex-Pb4QVzSmVHUMy-A5cULJmrmc8&sz=w800', 'https://drive.google.com/thumbnail?id=1Qn_vuIGkW-rZfyjYeVVZFObtpGwV8P0g&sz=w800']
  }]
}, {
  id: 'ref-008',
  icon: 'User',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1XSJtPTtwXuJ5lR9Np8fXmXJ272FPRsu3&sz=w800', 'https://drive.google.com/thumbnail?id=1kZSE3zPbV9hUIHLhwNpi-b8SJvogG2YA&sz=w800', 'https://drive.google.com/thumbnail?id=1lbB82dzJi-M3Rwd5rtMy3eUaWxNyoUe_&sz=w800', 'https://drive.google.com/thumbnail?id=1W7aFyU_4DcmC8ZDaeoUnNgT1u-NwbtVt&sz=w800', 'https://drive.google.com/thumbnail?id=1jjGup-sp_FF47nOb19vSwfC0h6sFhxx6&sz=w800', 'https://drive.google.com/thumbnail?id=1SIHdB749Zipx-Ek7tpnR__GGeOvtb5QM&sz=w800', 'https://drive.google.com/thumbnail?id=1Mxha6JjEDh0L-NHiC4NPM4eIoPgjPG_N&sz=w800', 'https://drive.google.com/thumbnail?id=1HlSygwfoqcMY2UPFVShmPJnBfVVZ1moa&sz=w800', 'https://drive.google.com/thumbnail?id=1T46bNkHKiowIuS__ItRx2F_5syMhaURx&sz=w800']
  }, {
    name: '範例 2',
    provider: 'YAO',
    slides: ['https://drive.google.com/thumbnail?id=1432mBIdMiTU4IteWIisacxEQkwRNMEOz&sz=w800', 'https://drive.google.com/thumbnail?id=1MF8ZNqi873PhQ7bgpIDrTi7NYo71rUr5&sz=w800', 'https://drive.google.com/thumbnail?id=1hKb7qDALkWE8A8ZW9TGA12cWJwCwwPdK&sz=w800', 'https://drive.google.com/thumbnail?id=1UQ93Oev9VC37AIXYukSwCPpB_KzbKaYt&sz=w800', 'https://drive.google.com/thumbnail?id=1Tpx6IuCWWcKE1qu4Kmh2al873eaMszOl&sz=w800', 'https://drive.google.com/thumbnail?id=1Qahmw9ZKDgDLFkiaxsvlHZiQJczrSnXf&sz=w800', 'https://drive.google.com/thumbnail?id=1E1Gf6qStPfXCG715j7NexzBuARzfpd3c&sz=w800', 'https://drive.google.com/thumbnail?id=1xfjPM4_kAuHrWCEoVHB-a59zYj78_izZ&sz=w800', 'https://drive.google.com/thumbnail?id=1LdeCZ5lVSe1mbxZCno2Sd-qrsxlSmSrg&sz=w800', 'https://drive.google.com/thumbnail?id=1rdVtCkKFrlibhQOdbmEqVjaVKxNy0J98&sz=w800']
  }]
}, {
  id: 'ref-009',
  icon: 'Monitor',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1KbBh7H6wRtsdtBvnh5UZ4aey3RT-M4xW&sz=w800', 'https://drive.google.com/thumbnail?id=16Bs4_Tg7Swj8HXAAsshamS5eNJquj63f&sz=w800', 'https://drive.google.com/thumbnail?id=1BrJDOOeTUOZO-iVSfSTAjCZRre2OvUQv&sz=w800', 'https://drive.google.com/thumbnail?id=1D0kiepzL6bgnxfJTCzahpSGMqoV0T7CA&sz=w800', 'https://drive.google.com/thumbnail?id=1Dyq5zEujR3W4hXFl3leAQGo9DLqdRfbe&sz=w800', 'https://drive.google.com/thumbnail?id=1ohE-Z0CufmBEDTHxsjIX_nduZjRK-ur5&sz=w800', 'https://drive.google.com/thumbnail?id=1wm4jp20YRnCjypqoLSwzCHahGFQrvcpa&sz=w800', 'https://drive.google.com/thumbnail?id=1lmQ_iiRwYVPd42DfsoWpSAbdpBGWl9qO&sz=w800', 'https://drive.google.com/thumbnail?id=1aIQV25y9t4hnbetkacinj0Gm4k9AY0ST&sz=w800']
  }]
}, {
  id: 'ref-010',
  icon: 'BookOpen',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1VJ9d5rj7HO77nstNCRTaM1x7o9vX1kC0&sz=w800', 'https://drive.google.com/thumbnail?id=1x9VoPMx3Cl02vfLtxgTSOZ80P1nra4Xk&sz=w800', 'https://drive.google.com/thumbnail?id=1DxJ_cCkg31S2SS_t9p1XqvO-agAprP8I&sz=w800', 'https://drive.google.com/thumbnail?id=13I_fdtwPcawiWtjS6go891Fbb9U2cKma&sz=w800', 'https://drive.google.com/thumbnail?id=1BM1gkoFln-Ey3Dlh1OY4lBjUP5yVt8dU&sz=w800', 'https://drive.google.com/thumbnail?id=1CvlaJvi15JaoLs0EinzHCF2pdgqvdv05&sz=w800', 'https://drive.google.com/thumbnail?id=1TGqwq1VcPjeTI33uT9bAZWecFmVwa_d3&sz=w800', 'https://drive.google.com/thumbnail?id=18V4cyXzwrDHv1ALQs0PA3js_nazmqDns&sz=w800', 'https://drive.google.com/thumbnail?id=1fvpaSt4xBGocNSVIU8IxXejeXf_xgIFX&sz=w800']
  }]
}, {
  id: 'ref-011',
  icon: 'Smile',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=16itVljg9hN7K2Rdg3LtzLNJHTqTqAj2s&sz=w800', 'https://drive.google.com/thumbnail?id=1moDOMdExCqf0k_SLly46q_q5urD5tTWi&sz=w800', 'https://drive.google.com/thumbnail?id=1_pMDPn-YXpxY-anHV6uQYxOVFVmhQudj&sz=w800', 'https://drive.google.com/thumbnail?id=1J8qTStBQCR5b49gQ8ZUpMMgUsGNuYok6&sz=w800', 'https://drive.google.com/thumbnail?id=1_CnVvo-85QTSZkSEj4bIvX3e-XrqfTWj&sz=w800', 'https://drive.google.com/thumbnail?id=1Yt9-5N3X--zgkPuv1X6Kz1NbEXxpLEw2&sz=w800', 'https://drive.google.com/thumbnail?id=1KAzvcbM3Edd9KshxhWwa4xIk4HSblYKf&sz=w800', 'https://drive.google.com/thumbnail?id=1UkZ8qPCXjDEaCcWPw72xLd4aGNL5Byfp&sz=w800', 'https://drive.google.com/thumbnail?id=1nRpVxlUC2ee9SywfceSmA2yNDwaB7mS-&sz=w800']
  }]
}, {
  id: 'ref-012',
  icon: 'Layout',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1ZVte7XnHE7GcKy1ICWg9CBlKyOqTjHa3&sz=w800', 'https://drive.google.com/thumbnail?id=10bbhgGdJsx3abZDfYoQpsXG6OQ4VXFT2&sz=w800', 'https://drive.google.com/thumbnail?id=1c6cOFhmRz6_rJOMZANpceNRt81EmwLEd&sz=w800', 'https://drive.google.com/thumbnail?id=1uShraVaaG9sFRDxMZwQ_A47iKxl0-eQj&sz=w800', 'https://drive.google.com/thumbnail?id=1i8a7oZG2oEyCD0ppLaWYCSsGHh74u9xR&sz=w800', 'https://drive.google.com/thumbnail?id=1sRkrBt9P2zmsJ_UdncgNxyCnud1Om5ZY&sz=w800', 'https://drive.google.com/thumbnail?id=1rHY47r3lKkAH1uYceT7-DfGv_T9PcpDz&sz=w800', 'https://drive.google.com/thumbnail?id=1-YmR7-F-nkVNsry6YBQGhSpkr00ylkyE&sz=w800', 'https://drive.google.com/thumbnail?id=12FxMQcAXfTEchQipEPsDSiaWSwYePkNi&sz=w800', 'https://drive.google.com/thumbnail?id=1aX0wOPALiGyo7bBBlMHFHPagKVV76y66&sz=w800', 'https://drive.google.com/thumbnail?id=1tp05Sa6Kt9MQaJBsPSLrANYzZeY--5yB&sz=w800', 'https://drive.google.com/thumbnail?id=1c9JhLLoz6-ZcUP6QCzheh1glGhCUsn14&sz=w800', 'https://drive.google.com/thumbnail?id=1dDhfB5NfgAyUsF4Vsq_pU0lE8kp6BRhc&sz=w800', 'https://drive.google.com/thumbnail?id=1I_4aLxt7AaExXCt1xvlMeNvO6TSGRWfJ&sz=w800', 'https://drive.google.com/thumbnail?id=1rCAVQcs0uG0_ZyaeOODzpvv4qrkYezz7&sz=w800']
  }]
}, {
  id: 'ref-013',
  icon: 'Monitor',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1fgk7eW2r08ueoyDx9tsuTb0mpr935HYg&sz=w800', 'https://drive.google.com/thumbnail?id=1Z9kbvjzsdlhtdp3wT6aRwOFtxBwRguEG&sz=w800', 'https://drive.google.com/thumbnail?id=15YoVmm4VpTq8VTx-gsEQCoKikBjKwgzC&sz=w800', 'https://drive.google.com/thumbnail?id=1E5lIJeXWur-6yWWxcipAA21nL44Fw63e&sz=w800', 'https://drive.google.com/thumbnail?id=1ZqHehiu4jRfslQNPotgrgpc99bYY0k80&sz=w800', 'https://drive.google.com/thumbnail?id=1IqXegq0F1y6FZLGq7YTCZP9tHI4h5HTE&sz=w800', 'https://drive.google.com/thumbnail?id=1BP6dx7lQMuf-F1tAmNY7jG7v0_hxvesw&sz=w800', 'https://drive.google.com/thumbnail?id=1LyjJRxU-5pKxfreTyhWeTKXAuv-zWYf2&sz=w800', 'https://drive.google.com/thumbnail?id=1EJRsIaOikNd8S11X8BcruJm8_9hSFfxP&sz=w800', 'https://drive.google.com/thumbnail?id=1c7KRhXBDXgRHaqcuHzTxfz4EDVUxWvyR&sz=w800']
  }]
}, {
  id: 'ref-014',
  icon: 'User',
  ...
  examples: [{
    name: '範例 1',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1c8103FPIRoQPXMxho6I8ROa9YoOgN8Mc&sz=w800', 'https://drive.google.com/thumbnail?id=1q2MIWo57SA6_l9jZfhrgCOXXH_c5cA4H&sz=w800', 'https://drive.google.com/thumbnail?id=1zaphaqOEZx1XdvgFlixfi78fwgPjcKU5&sz=w800', 'https://drive.google.com/thumbnail?id=1fpd-B2_nXkF3Ab1Ibb_D_Vwc5-o3Rpe5&sz=w800', 'https://drive.google.com/thumbnail?id=1k_jazpHzjCS1t-N6atsonwhyjpM-qJ8o&sz=w800', 'https://drive.google.com/thumbnail?id=1d9ddrBxefOVgNo9nz165Kz4uFaqqKijZ&sz=w800', 'https://drive.google.com/thumbnail?id=1BTqVcwW8J21vZXRzi_4YhYu8quLBJv2v&sz=w800', 'https://drive.google.com/thumbnail?id=1Mn1qsvflwxofFACiocQJZPnbPGawwGTH&sz=w800', 'https://drive.google.com/thumbnail?id=1m9h7HoFYikZhwltqOMmIfit-cvK4Nv0A&sz=w800', 'https://drive.google.com/thumbnail?id=1ANBl1XMuLRNYk134DjHn92eiDDj2yW3M&sz=w800', 'https://drive.google.com/thumbnail?id=1eucDqrY89i7rEeLPma4h7eOprrmuB8z3&sz=w800', 'https://drive.google.com/thumbnail?id=1mUC3mVxUsjTnXmt_DbWKgBUNyYcm8fNB&sz=w800', 'https://drive.google.com/thumbnail?id=1o5cFFRuy7I3Nxx0dHNSqmtpxU8pRZvhV&sz=w800']
  }, {
    name: '範例 2',
    provider: 'Meiko',
    slides: ['https://drive.google.com/thumbnail?id=1402dHGFbvTVtt3jG_-vcd_60FCgUYqXd&sz=w800', 'https://drive.google.com/thumbnail?id=1vExePZWJ5iKEab1M-wB7dsYyZfx84rSC&sz=w800', 'https://drive.google.com/thumbnail?id=1dLtqW6_xk-PkL6BCo04UrKoKAbMoviX7&sz=w800', 'https://drive.google.com/thumbnail?id=1VjQAIgPLqrAvjRM4QWxlOdqB2Pmkwb9L&sz=w800', 'https://drive.google.com/thumbnail?id=1zTMvb_BYzIxK82wGKyscnjKWyiIZBntm&sz=w800', 'https://drive.google.com/thumbnail?id=1QwnxJ9eQdbCvxiX5Bnbq8al1ze-3Y4lV&sz=w800', 'https://drive.google.com/thumbnail?id=1rJLcZ9EW1mWIToxzYsRmmXVoi9I8ptdF&sz=w800', 'https://drive.google.com/thumbnail?id=1h8b7IYKhLocoZ4o3NE7KLYxbADzyClaA&sz=w800', 'https://drive.google.com/thumbnail?id=1swMXzx9upeZCeIggUHBFfWjw4-xeWmKS&sz=w800', 'https://drive.google.com/thumbnail?id=1t38bShE7AtU6bw0evg-xfpgjUlAJMOe8&sz=w800']
  }]
}];
const PdfTools = ({
  language = 'zh'
  ...
  const loadScriptOnce = src => new Promise((resolve, reject) => {
    ...
    if (found && window.jspdf && window.jspdf.jsPDF) {
      resolve();
      return;
    }
    ...
    script.onerror = () => {
      clearTimeout(timer);
      reject(new Error(P('無法載入 PDF 匯出元件', 'Unable to load the PDF export component')));
    };
    if (!found) {
      script.src = src;
  ...
  const loadPdf = async event => {
    ...
    setBusy(true);
    setStatus(P('正在讀取並建立縮圖…', 'Reading PDF and creating thumbnails…'));
    try {
      const rendered = [];
      let globalNumber = 1;
      let firstDoc = null;
      ...
      setStatus(P('PDF 讀取失敗，請確認檔案未加密或損壞。', 'Could not read the PDF. Make sure it is not encrypted or damaged.'));
    } finally {
      setBusy(false);
      event.target.value = '';
    }
  ...
  const applyEraseRegionToAll = () => {
    ...
    setEraseRegions(Object.fromEntries(pages.map(page => [page.number, {
      ...sharedRegion
    }])));
  ...
  const loadOverlayLogo = event => {
    ...
    reader.onload = () => {
      const img = new Image();
      img.onload = () => {
        setOverlayLogoImage(img);
        setOverlayLogoUrl(reader.result);
        setStatus(P('Logo 已載入，匯出時會套用至所有選取頁。', 'Logo loaded and will be applied to all selected pages.'));
      };
  ...
  const applyPostProcessing = (canvas, sourcePageNumber, numberedIndex, numberedTotal, scale) => {
    ...
    if (overlayLogoImage) {
      ...
      const mx = mmPx(overlayLogoMarginX),
        my = mmPx(overlayLogoMarginY);
    ...
    if (addPageNumbers && !(skipCoverNumber && sourcePageNumber === 1) && numberedIndex >= 0) {
      ...
      const label = postPageNumFormat === 'total' ? `${number} / ${Number(postPageNumStart || 1) + numberedTotal - 1}` : postPageNumFormat === 'word' ? language === 'en' ? `Page ${number}` : `第 ${number} 頁` : postPageNumFormat === 'fullword' ? language === 'en' ? `Page ${number} / ${numberedTotal}` : `第 ${number} 頁 / 共 ${numberedTotal} 頁` : String(number);
  ...
  const getTextLogoPreviewStyle = page => {
    ...
    if (overlayLogoUrl) {
      ...
      if (overlayLogoPos.startsWith('b')) style.bottom = `calc(${yPct + logoHeightPct}% + 3px)`;else style.top = `calc(${yPct + logoHeightPct}% + 3px)`;
    }
    return style;
  };
  const exportFiles = async () => {
    if (!pdfDoc || !selected.length) {
      setStatus(P('請至少選擇一張投影片。', 'Select at least one page.'));
      return;
    }
    setBusy(true);
    setStatus(P('正在產生匯出檔案…', 'Creating export files…'));
    try {
      ...
      if (exportType === 'images') {
        ...
        for (const n of selected) {
          ...
          if (zip) zip.file(imageName, blob);else downloadBlob(blob, imageName);
        ...
        for (const n of selected) {
          ...
          const pageW = r.width / pdfScale,
            pageH = r.height / pdfScale;
          const orientation = r.width >= r.height ? 'landscape' : 'portrait';
          if (!out) out = new jsPDF({
            orientation,
            unit: 'pt',
            format: [pageW, pageH],
            compress: true,
      ...
      setStatus(language === 'en' ? `Done: exported ${selected.length} page(s)${cropBottom ? ` and cropped ${Number(cropBottomCm) || 0} cm from the bottom` : eraseLogo ? ` with custom erase areas applied to ${selected.filter(n => eraseRegions[n]).length} page(s)` : ''}${overlayLogoImage || overlayLogoText.trim() ? ', with a custom logo' : ''}${addPageNumbers ? ', with page numbers' : ''}.` : `完成：已匯出 ${selected.length} 頁${cropBottom ? `，並裁除下方約 ${Number(cropBottomCm) || 0} 公分` : eraseLogo ? `，已抹除 ${selected.filter(n => eraseRegions[n]).length} 頁的自訂框選範圍` : ''}${overlayLogoImage || overlayLogoText.trim() ? '，已加入自訂 Logo' : ''}${addPageNumbers ? '，已加入頁碼' : ''}。`);
    } catch (error) {
      console.error(error);
      setStatus(language === 'en' ? `Export failed: ${error && error.message ? error.message : 'try exporting fewer pages'}.` : `匯出失敗：${error && error.message ? error.message : '請嘗試減少頁數'}。`);
    } finally {
      setBusy(false);
    }
  };
  const activeEraseRegion = eraseEditorPage ? drawingRegion && drawingRegion.pageNumber === eraseEditorPage.number ? drawingRegion : eraseRegions[eraseEditorPage.number] : null;
  return /*#__PURE__*/React.createElement("div", {
    className: "animate-in pb-10 space-y-6"
  }, showPptxNotice && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-[100] bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-5",
    role: "dialog",
    "aria-modal": "true",
    "aria-labelledby": "pptx-notice-title"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full max-w-md rounded-2xl border border-pink-300/40 bg-slate-900 p-6 shadow-2xl"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-12 h-12 rounded-xl bg-pink-300/15 text-pink-300 flex items-center justify-center mb-4"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "FileText",
    size: 25
  ...
  }, P('請先將 PPTX 另存為 PDF', 'Please save the PPTX as a PDF first')), /*#__PURE__*/React.createElement("p", {
    className: "text-sm leading-relaxed text-slate-300"
  }, P('為了完整保留字型、圖表與版面，這個工具不會上傳或直接轉換 PPTX。請在 PowerPoint 選擇「檔案 → 另存新檔／匯出 → PDF」，再回來選擇轉好的 PDF。', 'To preserve fonts, charts, and layout, this tool does not upload or convert PPTX files. In PowerPoint, choose File → Save As / Export → PDF, then select the exported PDF here.')), /*#__PURE__*/React.createElement("div", {
    className: "mt-6 flex gap-3"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowPptxNotice(false),
    className: "flex-1 py-3 rounded-xl border border-slate-600 text-slate-300 font-bold hover:bg-slate-800"
  }, P('稍後處理', 'Later')), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setShowPptxNotice(false);
      setTimeout(() => pdfInputRef.current && pdfInputRef.current.click(), 0);
    },
    className: "flex-1 py-3 rounded-xl bg-pink-300 text-slate-900 font-black hover:bg-pink-200"
  }, P('重新選擇 PDF', 'Choose PDF again'))))), document.body), eraseEditorPage && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-[110] bg-slate-950/90 backdrop-blur-sm flex items-center justify-center p-4 md:p-8",
    role: "dialog",
    "aria-modal": "true",
    "aria-labelledby": "erase-editor-title"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full max-w-6xl max-h-full rounded-2xl border border-pink-300/40 bg-slate-900 shadow-2xl flex flex-col overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "px-5 py-4 border-b border-slate-700 flex flex-wrap items-center justify-between gap-3"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    id: "erase-editor-title",
    className: "font-black text-white"
  }, P('框選要抹除的範圍', 'Select the area to erase')), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-400 mt-1"
  }, P(`第 ${eraseEditorPage.number} 頁`, `Page ${eraseEditorPage.number}`), " \xB7 ", P('在大圖上按住並拖曳，再次框選可重新設定', 'Drag over the large preview; drag again to replace the selection'), eraseEditorLoading ? P(' · 正在載入高解析度預覽…', ' · Loading high-resolution preview…') : P(' · 高解析度預覽', ' · High-resolution preview'))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setEraseEditorPage(null);
      setDrawingRegion(null);
    },
    className: "px-4 py-2 rounded-lg border border-slate-600 text-sm font-bold text-slate-300 hover:bg-slate-800"
  }, P('關閉', 'Close'))), /*#__PURE__*/React.createElement("div", {
    className: "flex-1 min-h-0 overflow-auto p-4 md:p-6 bg-slate-950 flex items-center justify-center"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    src: eraseEditorUrl || eraseEditorPage.url,
    draggable: "false",
    className: `block w-full h-full object-contain bg-white pointer-events-none ${eraseEditorLoading ? 'opacity-70' : ''}`
  }), activeEraseRegion && /*#__PURE__*/React.createElement("span", {
    className: "absolute border-2 border-pink-400 bg-pink-300/25 pointer-events-none shadow-[0_0_0_9999px_rgba(2,6,23,.28)]",
    style: {
      left: `${activeEraseRegion.x * 100}%`,
      top: `${activeEraseRegion.y * 100}%`,
      width: `${activeEraseRegion.w * 100}%`,
      height: `${activeEraseRegion.h * 100}%`
    }
  }))), /*#__PURE__*/React.createElement("div", {
    className: "px-5 py-4 border-t border-slate-700 flex flex-wrap items-center justify-between gap-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    disabled: eraseEditorPage.number === pages[0]?.number,
    onClick: () => moveEraseEditor(-1),
    className: "px-4 py-2 rounded-lg border border-slate-600 text-xs font-bold disabled:opacity-30"
  }, P('上一頁', 'Previous')), /*#__PURE__*/React.createElement("button", {
    disabled: eraseEditorPage.number === pages[pages.length - 1]?.number,
    onClick: () => moveEraseEditor(1),
    className: "px-4 py-2 rounded-lg border border-slate-600 text-xs font-bold disabled:opacity-30"
  }, P('下一頁', 'Next'))), eraseAllApplied && /*#__PURE__*/React.createElement("div", {
    className: "order-last sm:order-none w-full sm:w-auto rounded-lg border border-emerald-400/40 bg-emerald-400/10 px-3 py-2 text-xs font-bold text-emerald-200 flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-5 h-5 rounded-full bg-emerald-300 text-slate-900 flex items-center justify-center"
  }, "\u2713"), P(`已套用到全部 ${pages.length} 頁`, `Applied to all ${pages.length} pages`)), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setEraseRegions(current => {
        ...
        delete next[eraseEditorPage.number];
        return next;
      });
      setEraseAllApplied(false);
    },
    className: "px-4 py-2 rounded-lg border border-red-400/30 text-xs font-bold text-red-300"
  }, P('清除此頁範圍', 'Clear this page')), /*#__PURE__*/React.createElement("button", {
    disabled: !activeEraseRegion,
    onClick: applyEraseRegionToAll,
    className: `px-4 py-2 rounded-lg border text-xs font-bold disabled:opacity-30 ${eraseAllApplied ? 'bg-emerald-300 border-emerald-300 text-slate-900' : 'border-pink-300/40 text-pink-200'}`
  }, eraseAllApplied ? P(`✓ 已套用全部 ${pages.length} 頁`, `✓ Applied to all ${pages.length} pages`) : P('套用此範圍到所有頁', 'Apply area to all pages')), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setEraseEditorPage(null);
      setDrawingRegion(null);
    },
    className: "px-5 py-2 rounded-lg bg-pink-300 text-slate-900 text-xs font-black"
  }, P('完成框選', 'Done')))))), document.body), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-lg font-black text-white mb-2"
  }, P('PDF後製（去除NotebookLM Logo）', 'PDF Post-processing (Remove NotebookLM Logo)')), /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-slate-400 mb-5"
  }, P('PDF 僅在目前瀏覽器中處理。可一次上傳多個 PDF 合併、分頁、自訂裁切或框選抹除，再加入自訂 Logo、頁碼並匯出圖片或 PDF。', 'PDF files are processed only in this browser. Upload and merge multiple PDFs, select pages, crop or erase an area, then add a custom logo or page numbers and export as images or PDF.')), /*#__PURE__*/React.createElement("label", {
    className: "min-h-[130px] border-2 border-dashed border-slate-600 hover:border-pink-300 rounded-2xl flex flex-col items-center justify-center gap-3 cursor-pointer bg-slate-900/40 transition-colors"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "FileText",
    size: 30,
    ...
    className: "font-bold"
  }, busy ? P('處理中…', 'Processing…') : P('點此選擇 PDF 檔案（可複選合併）', 'Choose PDF files (select multiple to merge)')), /*#__PURE__*/React.createElement("input", {
    ref: pdfInputRef,
    type: "file",
    ...
    disabled: busy,
    className: "hidden"
  }))), pages.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-5 rounded-2xl flex flex-wrap gap-3 items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "font-bold text-white"
  }, fileName, ".pdf"), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-slate-400 mt-1"
  }, P(`已選 ${selected.length} / ${pages.length} 頁`, `${selected.length} / ${pages.length} pages selected`))), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => clearAllSlides(true),
    className: "px-4 py-2 rounded-lg border border-red-400/40 bg-red-400/10 text-red-200 hover:bg-red-400/20 text-sm font-bold flex items-center gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "RotateCcw",
    size: 15
  }), P('清除並重新上傳', 'Clear & upload again')), /*#__PURE__*/React.createElement("button", {
    onClick: selectAll,
    className: "px-4 py-2 rounded-lg bg-slate-700 hover:bg-slate-600 text-sm font-bold"
  }, selected.length === pages.length ? P('取消全選', 'Deselect all') : P('全選', 'Select all')), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center rounded-lg border border-slate-600 bg-slate-900 overflow-hidden"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setCropBottom(!cropBottom);
      if (!cropBottom) setEraseLogo(false);
    },
    className: `px-4 py-2 text-sm font-bold ${cropBottom ? 'bg-pink-300 text-slate-900' : 'text-slate-300'}`
  }, cropBottom ? P('✓ 已顯示裁切線', '✓ Crop line shown') : P('啟用裁切線', 'Enable crop line')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0.1",
    max: "10",
    step: "0.1",
    ...
    onChange: e => {
      setCropBottomCm(e.target.value);
      setCropBottom(true);
      setEraseLogo(false);
    },
    className: "w-16 bg-slate-950 border-l border-slate-600 px-2 py-2 text-sm text-center"
  }), /*#__PURE__*/React.createElement("span", {
    className: "px-2 text-xs text-slate-400"
  }, P('公分', 'cm'))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
    ...
    className: `px-4 py-2 rounded-lg border text-sm font-bold ${eraseLogo ? 'bg-pink-300 text-slate-900 border-pink-300' : 'bg-slate-900 text-slate-300 border-slate-600'}`
  }, eraseLogo ? P('✓ 框選抹除範圍', '✓ Erase area selected') : P('自行框選抹除範圍', 'Select area to erase'))), eraseLogo && /*#__PURE__*/React.createElement("div", {
    className: "w-full mt-1 rounded-xl border border-amber-400/30 bg-amber-400/10 px-4 py-3 flex items-start gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Info",
    size: 16,
  ...
  }, P('操作方式：', 'How to use: ')), P('點選縮圖會開啟高解析度大型預覽，再於大圖上拖曳框選。每頁可設定不同範圍，也可將同一範圍套用到所有頁；未框選的頁面不會執行抹除。白色或單純背景效果最佳，複雜背景仍可能留下些微痕跡。', 'Click a thumbnail to open a high-resolution preview, then drag over the area to erase. Set a different area per page or apply one area to every page. Pages without a selected area will not be erased. Simple or white backgrounds work best.'))), cropBottom && /*#__PURE__*/React.createElement("div", {
    className: "w-full mt-1 rounded-xl border border-pink-300/30 bg-pink-300/10 px-4 py-3 flex items-start gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Scissors",
    size: 16,
    className: "text-pink-300 mt-0.5 flex-shrink-0"
  }), /*#__PURE__*/React.createElement("p", {
    className: "text-xs leading-relaxed text-pink-100"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-black"
  }, P('裁切參考線：', 'Crop guide: ')), P('縮圖下方的紅色虛線是實際裁切邊界，虛線以下會被移除；調整公分數時，參考線會依投影片實際尺寸即時移動。', 'The red dashed line near the bottom of each thumbnail is the crop boundary. Everything below it will be removed, and the guide updates as you change the value.')))), /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      role: "button",
      tabIndex: "0",
      onClick: () => eraseLogo ? openEraseEditor(p) : togglePage(p.number),
      onKeyDown: e => {
        if (e.key === 'Enter' || e.key === ' ') eraseLogo ? openEraseEditor(p) : togglePage(p.number);
      },
      className: `pdf-thumb text-left rounded-xl overflow-hidden border-2 bg-slate-900 transition-all ${selected.includes(p.number) ? 'border-pink-300 shadow-[0_0_14px_rgba(249,168,212,.25)]' : 'border-slate-700 opacity-60'}`
    }, /*#__PURE__*/React.createElement("div", {
      className: `${p.landscape ? 'aspect-video' : 'aspect-[3/4]'} bg-slate-950 flex items-center justify-center overflow-hidden relative`
    }, /*#__PURE__*/React.createElement("div", {
      className: `relative max-w-full max-h-full ${eraseLogo ? 'cursor-zoom-in' : ''}`,
      style: {
        aspectRatio: `${p.widthPt} / ${p.heightPt}`,
        width: p.landscape ? '100%' : 'auto',
        height: p.landscape ? 'auto' : '100%'
      }
    }, /*#__PURE__*/React.createElement("img", {
      src: p.url,
      draggable: "false",
      className: "block w-full h-full object-contain select-none"
    }), cropBottom && cropPct > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "absolute inset-x-0 bottom-0 bg-rose-400/25 pointer-events-none z-10",
      style: {
        height: `${Math.max(cropPct, .8)}%`
      }
    }), /*#__PURE__*/React.createElement("div", {
      className: "absolute inset-x-0 pointer-events-none z-[60]",
      style: {
        bottom: `${cropPct}%`,
        height: '1px',
    ...
    })), overlayLogoUrl && /*#__PURE__*/React.createElement("img", {
      src: overlayLogoUrl,
      style: getLogoPreviewStyle(p),
      className: "absolute object-contain drop-shadow-sm"
    }), overlayLogoText.trim() && /*#__PURE__*/React.createElement("span", {
      style: getTextLogoPreviewStyle(p),
      className: "absolute"
    }, overlayLogoText.trim()), eraseLogo && region && /*#__PURE__*/React.createElement("span", {
      className: "absolute border-2 border-pink-400 bg-pink-300/20 pointer-events-none",
      style: {
        left: `${region.x * 100}%`,
        top: `${region.y * 100}%`,
        width: `${region.w * 100}%`,
      ...
      className: "px-3 py-2 text-xs font-bold flex items-center justify-between gap-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "min-w-0"
    }, P(`第 ${p.number} 頁`, `Page ${p.number}`), " \xB7 ", p.landscape ? P('橫向', 'Landscape') : P('直向', 'Portrait'), p.sourceName ? ` · ${p.sourceName}` : ''), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2 flex-shrink-0"
    }, cropBottom && /*#__PURE__*/React.createElement("span", {
      className: "text-[9px] px-1.5 py-0.5 rounded bg-red-500/15 border border-red-400/40 text-red-200 font-bold whitespace-nowrap"
    }, P('裁切', 'Crop'), " ", Number(cropBottomCm) || 0, " cm"), eraseLogo && /*#__PURE__*/React.createElement("span", {
      className: `text-[9px] px-1.5 py-0.5 rounded font-bold ${eraseRegions[p.number] ? 'bg-pink-300 text-slate-900' : 'bg-slate-700 text-slate-300'}`
    }, eraseRegions[p.number] ? P('✓ 已框選', '✓ Area set') : P('點圖框選', 'Click to select')), /*#__PURE__*/React.createElement("button", {
      type: "button",
      "aria-label": language === 'en' ? `${selected.includes(p.number) ? 'Deselect' : 'Select'} page ${p.number}` : `${selected.includes(p.number) ? '取消選取' : '選取'}第 ${p.number} 頁`,
      onClick: event => {
        event.preventDefault();
        event.stopPropagation();
        togglePage(p.number);
      },
      className: `w-6 h-6 rounded-full border flex items-center justify-center flex-shrink-0 ${selected.includes(p.number) ? 'bg-pink-300 border-pink-300 text-slate-900' : 'bg-slate-950 border-slate-600 text-transparent'}`
    }, "\u2713"))));
  })), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/60 border border-slate-700 p-6 rounded-2xl space-y-6"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-black text-pink-300"
  }, P('加入自訂 Logo 與頁碼', 'Add Custom Logo & Page Numbers')), /*#__PURE__*/React.createElement("div", {
  ...
  }, P('自訂 Logo', 'Custom Logo')), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-slate-500 mt-1"
  }, P('建議透明背景 PNG，套用至所有選取頁', 'A transparent PNG is recommended; applied to all selected pages'))), overlayLogoUrl && /*#__PURE__*/React.createElement("img", {
    src: overlayLogoUrl,
    className: "w-14 h-14 object-contain bg-white rounded-lg p-1"
  })), /*#__PURE__*/React.createElement("label", {
    className: "block text-center py-3 rounded-lg border-2 border-dashed border-slate-600 hover:border-pink-300 cursor-pointer text-sm font-bold text-slate-300"
  }, overlayLogoImage ? P('更換 Logo 圖片', 'Replace logo image') : P('上傳 Logo 圖片', 'Upload logo image'), /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "image/png,image/jpeg,image/webp",
    onChange: loadOverlayLogo,
    className: "hidden"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('Logo 文字（可單獨使用，或與圖片一起使用）', 'Logo text (use alone or with an image)')), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: overlayLogoText,
    onChange: e => setOverlayLogoText(e.target.value),
    placeholder: P('例如：公司名稱、品牌縮寫', 'e.g. company name or brand initials'),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), (overlayLogoImage || overlayLogoText.trim()) && /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-3"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('固定位置', 'Position')), /*#__PURE__*/React.createElement("select", {
    value: overlayLogoPos,
    onChange: e => setOverlayLogoPos(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  }, /*#__PURE__*/React.createElement("option", {
    value: "tl"
  }, P('左上角', 'Top left')), /*#__PURE__*/React.createElement("option", {
    value: "tr"
  }, P('右上角', 'Top right')), /*#__PURE__*/React.createElement("option", {
    value: "bl"
  }, P('左下角', 'Bottom left')), /*#__PURE__*/React.createElement("option", {
    value: "br"
  }, P('右下角', 'Bottom right')))), overlayLogoImage && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('圖片寬度（mm）', 'Image width (mm)')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "3",
    max: "80",
    step: "1",
    value: overlayLogoSizeMm,
    onChange: e => setOverlayLogoSizeMm(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), overlayLogoText.trim() && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('文字大小（pt）', 'Text size (pt)')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "6",
    max: "72",
    value: overlayLogoTextSize,
    onChange: e => setOverlayLogoTextSize(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), overlayLogoText.trim() && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('文字顏色', 'Text color')), /*#__PURE__*/React.createElement("input", {
    type: "color",
    value: overlayLogoTextColor,
    onChange: e => setOverlayLogoTextColor(e.target.value),
    className: "w-full h-10 bg-slate-900 border border-slate-600 rounded-lg p-1"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('水平邊距（mm）', 'Horizontal margin (mm)')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    max: "50",
    step: "1",
    value: overlayLogoMarginX,
    onChange: e => setOverlayLogoMarginX(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('垂直邊距（mm）', 'Vertical margin (mm)')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    max: "50",
    step: "1",
    value: overlayLogoMarginY,
    onChange: e => setOverlayLogoMarginY(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setOverlayLogoImage(null);
      setOverlayLogoUrl('');
      setOverlayLogoText('');
    },
    className: "col-span-2 py-2 text-xs font-bold text-red-300 border border-red-400/30 rounded-lg hover:bg-red-400/10"
  }, P('清除圖片與文字 Logo', 'Clear image and text logo')))), /*#__PURE__*/React.createElement("div", {
    className: "space-y-4 lg:border-l lg:border-slate-700 lg:pl-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "font-bold text-sm"
  }, P('加入頁碼', 'Add page numbers')), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-slate-500 mt-1"
  }, P('由工具實際寫入，不依賴 AI 生成', 'Written directly by this tool, not generated by AI'))), /*#__PURE__*/React.createElement("button", {
    onClick: () => setAddPageNumbers(!addPageNumbers),
    className: `px-4 py-2 rounded-lg border text-xs font-bold ${addPageNumbers ? 'bg-pink-300 text-slate-900 border-pink-300' : 'bg-slate-900 text-slate-400 border-slate-600'}`
  }, addPageNumbers ? P('✓ 已啟用', '✓ Enabled') : P('未啟用', 'Disabled'))), addPageNumbers && /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-3"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('位置', 'Position')), /*#__PURE__*/React.createElement("select", {
    value: postPageNumPos,
    onChange: e => setPostPageNumPos(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  }, /*#__PURE__*/React.createElement("option", {
    value: "bl"
  }, P('左下角', 'Bottom left')), /*#__PURE__*/React.createElement("option", {
    value: "bc"
  }, P('底部置中', 'Bottom center')), /*#__PURE__*/React.createElement("option", {
    value: "br"
  }, P('右下角', 'Bottom right')), /*#__PURE__*/React.createElement("option", {
    value: "watermark"
  }, P('原 Logo 位置（右下角貼邊）', 'Original logo position (bottom-right edge)')))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('格式', 'Format')), /*#__PURE__*/React.createElement("select", {
    value: postPageNumFormat,
    onChange: e => setPostPageNumFormat(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  }, /*#__PURE__*/React.createElement("option", {
    value: "simple"
  }, "1, 2, 3"), /*#__PURE__*/React.createElement("option", {
    value: "total"
  }, P('1 / 總頁數', '1 / Total')), /*#__PURE__*/React.createElement("option", {
    value: "word"
  }, P('第 1 頁', 'Page 1')), /*#__PURE__*/React.createElement("option", {
    value: "fullword"
  }, P('第 1 頁 / 共 10 頁', 'Page 1 / 10')))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('起始頁碼', 'Starting number')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "1",
    value: postPageNumStart,
    onChange: e => setPostPageNumStart(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('字體大小（pt）', 'Font size (pt)')), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "6",
    max: "36",
    value: postPageNumSize,
    onChange: e => setPostPageNumSize(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-sm"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs text-slate-400 block mb-1"
  }, P('文字顏色', 'Text color')), /*#__PURE__*/React.createElement("input", {
    type: "color",
    value: postPageNumColor,
    onChange: e => setPostPageNumColor(e.target.value),
    className: "w-full h-10 bg-slate-900 border border-slate-600 rounded-lg p-1"
  })), /*#__PURE__*/React.createElement("button", {
    onClick: () => setSkipCoverNumber(!skipCoverNumber),
    className: `self-end h-10 rounded-lg border text-xs font-bold ${skipCoverNumber ? 'bg-slate-700 border-slate-600 text-white' : 'bg-pink-300/15 border-pink-300 text-pink-300'}`
  }, P('封面是否需要頁碼：', 'Cover page number: '), skipCoverNumber ? P('不需要', 'No') : P('需要', 'Yes')))))), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/60 border border-slate-700 p-6 rounded-2xl space-y-5"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-black text-pink-300"
  }, P('匯出設定', 'Export Settings')), /*#__PURE__*/React.createElement("div", {
    className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-bold text-slate-400 block mb-2"
  }, P('匯出類型', 'Export type')), /*#__PURE__*/React.createElement("select", {
    value: exportType,
    onChange: e => setExportType(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-3"
  }, /*#__PURE__*/React.createElement("option", {
    value: "images"
  }, P('圖檔', 'Images')), /*#__PURE__*/React.createElement("option", {
    value: "pdf"
  }, "PDF"))), exportType === 'images' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-bold text-slate-400 block mb-2"
  }, P('下載方式', 'Download method')), /*#__PURE__*/React.createElement("select", {
    value: imagePackaging,
    onChange: e => setImagePackaging(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-3"
  }, /*#__PURE__*/React.createElement("option", {
    value: "direct"
  }, P('直接下載（不打包壓縮）', 'Direct download (no ZIP)')), /*#__PURE__*/React.createElement("option", {
    value: "zip"
  }, P('ZIP 壓縮檔', 'ZIP archive')))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-bold text-slate-400 block mb-2"
  }, P('圖檔格式', 'Image format')), /*#__PURE__*/React.createElement("select", {
    value: imageFormat,
    ...
    value: "jpg"
  }, "JPG"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-bold text-slate-400 block mb-2"
  }, P('圖片大小', 'Image size')), /*#__PURE__*/React.createElement("select", {
    value: sizeMode,
    onChange: e => setSizeMode(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-3"
  }, /*#__PURE__*/React.createElement("option", {
    value: "normal"
  }, P('正常大小（不限制）', 'Original size (no limit)')), /*#__PURE__*/React.createElement("option", {
    value: "medium"
  }, P('中品質（每張最多約 1.5MB）', 'Medium quality (up to ~1.5 MB each)')), /*#__PURE__*/React.createElement("option", {
    value: "low"
  }, P('低品質（每張最多約 800KB）', 'Low quality (up to ~800 KB each)')))))), exportType === 'images' && imagePackaging === 'direct' && selected.length > 1 && /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-amber-200 bg-amber-400/10 border border-amber-400/25 rounded-lg px-3 py-2"
  }, P('直接下載多張圖片時，瀏覽器可能會詢問是否允許下載多個檔案；若希望只下載一個檔案，請改選 ZIP 壓縮檔。', 'When downloading multiple images directly, your browser may ask for permission to download multiple files. Choose ZIP if you prefer a single download.')), /*#__PURE__*/React.createElement("button", {
    disabled: busy || !selected.length,
    onClick: exportFiles,
    className: "w-full py-4 rounded-xl bg-pink-300 hover:bg-pink-400 disabled:opacity-40 text-slate-900 font-black"
  }, busy ? P('正在處理…', 'Processing…') : P(`匯出選取的 ${selected.length} 頁`, `Export ${selected.length} selected pages`)), status && /*#__PURE__*/React.createElement("p", {
...
const App = () => {
  ...
  useEffect(() => {
    ...
    const apply = {
      ...
      needType: setNeedType,
      selectedStyle: setSelectedStyle,
      selectedLayout: setSelectedLayout,
      slideCount: setSlideCount,
      targetAudience: setTargetAudience,
      customTargetAudience: setCustomTargetAudience,
      presentationTime: setPresentationTime,
      context: setContext,
      customContext: setCustomContext,
      speakerTone: setSpeakerTone,
      customSpeakerTone: setCustomSpeakerTone,
      callToAction: setCallToAction,
      customCallToAction: setCustomCallToAction,
      roleType: setRoleType,
      customRole: setCustomRole,
      includeSpeakerNotes: setIncludeSpeakerNotes,
      needVisualStyle: setNeedVisualStyle,
      additionalNotes: setAdditionalNotes,
      customNeedType: setCustomNeedType,
      customStyleName: setCustomStyleName,
      customStyleDesc: setCustomStyleDesc,
      customLayoutName: setCustomLayoutName,
      customLayoutDesc: setCustomLayoutDesc,
      pastedOutline: setPastedOutline,
      useMainCharacter: setUseMainCharacter,
      keepMargins: setKeepMargins,
      selectedPalette: setSelectedPalette,
      backgroundChoice: setBackgroundChoice,
      dataVisualMode: setDataVisualMode,
      chartDensity: setChartDensity,
      chartTypeMode: setChartTypeMode,
      showChartValues: setShowChartValues,
      showDataSource: setShowDataSource,
      preserveDataUnits: setPreserveDataUnits,
      customPalettes: setCustomPalettes,
      useLogo: setUseLogo,
      logoText: setLogoText,
      logoPos: setLogoPos,
      usePageNum: setUsePageNum,
      pageNumPos: setPageNumPos,
      pageNumFormat: setPageNumFormat
    };
    Object.keys(apply).forEach(k => {
      if (s[k] !== undefined) apply[k](s[k]);
    });
    setHydrated(true);
  }, []);
  useEffect(() => {
  ...
  const updateCustomPaletteName = (id, name) => setCustomPalettes(prev => prev.map(p => p.id === id ? {
    ...p,
    name
  } : p));
  const updateCustomPaletteColor = (id, idx, val) => setCustomPalettes(prev => prev.map(p => p.id === id ? {
    ...p,
    colors: p.colors.map((c, i) => i === idx ? val : c)
  } : p));
  ...
  const needCategories = [{
    ...
    icon: 'Zap',
    recommendStyle: 'ref-001',
    recommendLayout: 'lay-1'
  }, {
    id: 'education',
    label: {
      zh: '教育與員工培訓',
    ...
    icon: 'BookOpen',
    recommendStyle: 'ref-0',
    recommendLayout: 'lay-4'
  }, {
    id: 'report',
    label: {
      zh: '專案與進度報告',
    ...
    icon: 'Sparkles',
    recommendStyle: 'ref-009',
    recommendLayout: 'lay-2'
  }, {
    id: 'data',
    label: {
      zh: '數據與成效分析',
    ...
    icon: 'BarChart3',
    recommendStyle: 'ref-006',
    recommendLayout: 'lay-5'
  }, {
    id: 'marketing',
    label: {
      zh: '行銷企劃與發想',
    ...
    label: {
      zh: '品牌故事 / 公司介紹',
      en: 'Brand Story / Company',
      ja: 'ブランド・会社紹介',
      ko: '브랜드 스토리 / 회사 소개'
    },
    icon: 'Sparkles',
    recommendStyle: 'ref-010',
    recommendLayout: 'lay-2'
  }, {
    id: 'healthcare',
    label: {
  ...
  const layoutCategories = [{
    ...
    desc: {
      zh: '提出痛點帶出解方，適合提案。',
      en: 'Raise pain points & provide solutions.',
      ja: '課題を提示し解決策を導く。',
      ko: '문제점 제시 후 해결책 도출.'
    }
  }, {
    ...
    desc: {
      zh: '引人入勝，適合行銷與品牌故事。',
      en: 'Engaging flow for marketing/branding.',
      ja: 'マーケティングやブランドストーリーに。',
      ko: '마케팅 및 브랜드 스토리에 적합.'
    }
  }, {
    id: 'lay-3',
    label: {
      zh: '時間軸演進',
      en: 'Timeline / Evolution',
      ja: 'タイムライン',
      ko: '타임라인 진행'
    },
    icon: 'History',
    desc: {
      zh: '適合回顧歷史、專案進度或規劃。',
      en: 'Best for history, progress, or roadmaps.',
      ja: '歴史やロードマップの振り返りに。',
      ko: '역사, 진행 상황 검토에 적합.'
    }
  }, {
    ...
    label: {
      zh: '結論與數據先行',
      en: 'Conclusion & Data First',
      ja: '結論・データ先行',
      ko: '결론 및 데이터 우선'
    },
    icon: 'BarChart3',
    desc: {
      zh: '先講結論再用數據支撐，適合主管報告。',
      en: 'Conclusion first, supported by data.',
      ja: '結論を先に述べ、データで裏付ける。',
      ko: '결론부터 말하고 데이터로 뒷받침.'
    }
  }, {
    id: 'lay-6',
    label: {
      zh: '黃金圈法則 (Why-How-What)',
      en: 'Golden Circle',
      ja: 'ゴールデンサークル',
      ko: '골든 서클'
    },
    ...
    desc: {
      zh: '從理念出發，先講為什麼再到做什麼。',
      en: 'Start with Why, then How and What.',
      ja: 'なぜ→どうやって→何を、の順で語る。',
      ko: '왜→어떻게→무엇을 순으로 전달.'
    }
  }, {
    id: 'lay-7',
    ...
    desc: {
      zh: '主角遇挑戰、蛻變、成功，感染力強。',
      en: 'Challenge, transformation, triumph.',
      ja: '挑戦・変化・成功で共感を生む。',
      ko: '도전·변화·성공으로 공감 유도.'
    }
  }, {
    ...
    desc: {
      zh: '透過前後或競品對比凸顯價值。',
      en: 'Highlight value via before/after.',
      ja: '前後や競合比較で価値を強調。',
      ko: '전후·경쟁 비교로 가치 부각.'
    }
  }, {
    ...
    desc: {
      zh: '特色、優勢、利益，適合銷售說服。',
      en: 'Features, Advantages, Benefits.',
      ja: '特徴・利点・便益で説得。',
      ko: '특징·장점·이점으로 설득.'
    }
  }, {
  ...
  const stylesTranslation = {
    'ref-015': {
      title: {
        zh: '白底商務簡約風格',
        en: 'White Minimal Business',
        ja: '白背景ミニマルビジネス',
        ko: '화이트 미니멀 비즈니스'
      },
      category: {
        zh: '白底商務簡約風格',
        en: 'White Business Minimalism',
        ja: '白背景ビジネスミニマル',
        ko: '화이트 비즈니스 미니멀'
      }
    },
    ...
    'ref-001': {
      title: {
        zh: '專業企業商務風格',
        en: 'Professional Corporate',
        ja: 'プロの企業ビジネス',
        ko: '전문 기업 비즈니스'
      },
      category: {
        zh: '高階商務/對外提案',
        en: 'High-end Business',
        ja: 'ハイエンドビジネス',
        ko: '고급 비즈니스'
      }
    },
    ...
    'ref-008': {
      title: {
        zh: '2.5D 等距視角風格+主角',
        en: '2.5D Isometric + Character',
        ja: '2.5D アイソメトリック + キャラ',
        ko: '2.5D 아이소메트릭 + 캐릭터'
      },
      category: {
        zh: '專屬角色導覽',
    ...
    'ref-014': {
      title: {
        zh: '教育型遊戲UI風格+主角',
        en: 'Edu Game UI + Character',
        ja: '教育ゲームUI + キャラ',
        ko: '교육용 게임 UI + 캐릭터'
      },
      category: {
        zh: '教育培訓/遊戲化',
        en: 'Education/Gamification',
        ja: '教育研修/ゲーミフィケーション',
        ko: '교육/게이미피케이션'
      }
    }
    ...
    referenceData.forEach(style => {
      if (style.generatorShow !== false && style.examples && style.examples.length > 0) {
        ...
        if (firstSlide) {
          ...
          thumb.src = firstSlide.replace('sz=w800', 'sz=w200');
        }
      }
    });
  }, []);
  const handleStyleHover = styleId => {
    ...
    if (targetStyle && targetStyle.examples && targetStyle.examples.length > 0) {
      targetStyle.examples[0].slides.forEach(slide => {
        const thumb = new Image();
        thumb.src = slide.replace('sz=w800', 'sz=w200');
        const img = new Image();
        img.src = slide;
      });
    }
...
${L.slLC}${spkNote(L.slLNote)}`;
  ...
  const stripTemplateColorCodeSentences = text => String(text || '').replace(/[^。！？.!?\n]*#[0-9A-Fa-f]{6}\b[^。！？.!?\n]*[。！？.!?]?/g, '').replace(/\n{3,}/g, '\n\n').trim();
  useEffect(() => {
  ...
  const handleStyleSelection = styleId => {
    const nextStyle = styleId === 'strict-business' ? getStrictBusinessPrompt('zh') : styleId === 'custom' ? customStyleDesc : referenceData.find(item => item.id === styleId)?.zhPrompt || '';
  ...
  const getFinalPromptText = lg => {
    ...
    const bgNames = {
      ...
      en: {
        ...
        ivory: 'ivory',
        gray: 'light gray',
        auto: 'automatically chosen by a color expert according to the content and selected palette'
      },
      ja: {
        white: '白',
        black: '黒',
      ...
      ko: {
        ...
        ivory: '아이보리',
        gray: '연한 회색',
        auto: '내용과 선택한 팔레트에 맞춰 전문가가 자동 설정'
      }
    };
    const bgLabels = {
      zh: '【背景色】',
    ...
    const templateAutoBackground = {
      zh: '依範本配色自動配置',
      en: 'automatically chosen from the template palette',
      ja: 'テンプレートの配色に合わせて自動設定',
      ko: '템플릿 팔레트에 맞춰 자동 설정'
    };
    const backgroundLabel = keepTemplatePalette && backgroundChoice === 'auto' ? templateAutoBackground[lg] || templateAutoBackground.zh : (bgNames[lg] || bgNames.zh)[backgroundChoice];
    ...
    if (dataVisualMode !== 'none') {
      const modeNames = {
        ...
        en: {
          auto: 'decide automatically from content',
          charts: 'prioritize charts',
          tables: 'prioritize tables',
          both: 'use both charts and tables'
        },
        ja: {
          auto: '内容に応じて自動判断',
          charts: 'グラフを優先',
      ...
      const typeNames = {
        zh: {
          auto: '由 AI 選擇合適類型',
          basic: '僅使用長條圖、折線圖、圓餅圖與表格'
        },
        en: {
          auto: 'let AI choose the appropriate type',
          basic: 'use only bar, line, pie charts and tables'
        },
        ja: {
          auto: 'AIが適切な種類を選択',
          basic: '棒・折れ線・円グラフと表のみ'
        },
        ko: {
          auto: 'AI가 적합한 유형 선택',
          basic: '막대·선·원형 차트와 표만 사용'
        }
      };
      const chartRules = {
      ...
      if (keepTemplatePalette) {
        chartRuleText = chartRuleText.replace('所選五色配色', '範本內的配色').replace('the selected five-color palette', 'the template palette').replace('選択した5色', 'テンプレート内の配色').replace('선택한 5색 팔레트', '템플릿 팔레트');
      }
  ...
  const renderFinalPrompt = text => String(text || '').split(/(【[^】\n]+】)/g).map((part, index) => /^【[^】\n]+】$/.test(part) ? /*#__PURE__*/React.createElement("span", {
    key: index,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, showPaletteConflict && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-[120] bg-slate-950/85 backdrop-blur-sm flex items-center justify-center p-5",
    role: "dialog",
    "aria-modal": "true",
    "aria-labelledby": "palette-conflict-title"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full max-w-lg rounded-2xl border border-pink-300/40 bg-slate-900 p-6 shadow-2xl"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-12 h-12 rounded-xl bg-pink-300/15 text-pink-300 flex items-center justify-center mb-4"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Palette",
    ...
    id: "palette-conflict-title",
    className: "text-xl font-black text-white mb-2"
  }, A('要使用哪一組配色？', 'Which color palette should be used?')), /*#__PURE__*/React.createElement("p", {
    className: "text-sm leading-relaxed text-slate-300"
  }, A('目前選擇的簡報範本本身含有色碼，同時又選擇了另一組配色。請選擇最終指令要保留哪一組，避免 AI 收到互相重疊的顏色要求。', 'The selected template already contains color codes, and you have also selected another palette. Choose which palette to keep so the AI receives only one set of color instructions.')), /*#__PURE__*/React.createElement("div", {
    className: "mt-5 space-y-3"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => resolvePaletteConflict('template'),
    className: "w-full rounded-xl border border-slate-600 bg-slate-800/70 p-4 text-left hover:border-pink-300 transition-colors"
  }, /*#__PURE__*/React.createElement("span", {
    className: "block font-black text-white"
  }, A('以範本配色為主', 'Use template palette')), /*#__PURE__*/React.createElement("span", {
    className: "block text-xs text-slate-400 mt-1"
  }, A('保留範本內的色碼，移除自選配色指令。', 'Keep the template color codes and remove the selected palette instructions.'))), /*#__PURE__*/React.createElement("button", {
    onClick: () => resolvePaletteConflict('custom'),
    className: "w-full rounded-xl border border-pink-300/50 bg-pink-300/10 p-4 text-left hover:bg-pink-300/15 transition-colors"
  }, /*#__PURE__*/React.createElement("span", {
    className: "block font-black text-pink-200"
  }, A('以自選配色為主', 'Use selected palette')), /*#__PURE__*/React.createElement("span", {
    className: "block text-xs text-slate-300 mt-1"
  }, A('保留目前選擇的五色配色，移除範本 Prompt 中含色碼的配色句子。', 'Keep the selected five-color palette and remove color-code instructions from the template prompt.')))), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] text-slate-500 mt-4"
  }, A('之後若更換範本或配色，系統會再次詢問。', 'You will be asked again if you change the template or palette.')))), document.body), /*#__PURE__*/React.createElement("div", {
    className: "max-w-[1200px] mx-auto w-full px-4 py-6 flex-grow"
  }, /*#__PURE__*/React.createElement("header", {
    className: "mb-3 bg-slate-800/40 p-5 md:p-6 rounded-2xl border border-slate-700/50 flex flex-col gap-6 shadow-xl backdrop-blur-md"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-xl sm:text-2xl md:text-3xl lg:text-[38px] leading-tight font-black tracking-wide text-white flex items-center gap-3 md:gap-4"
  }, /*#__PURE__*/React.createElement("img", {
    src: notebookLMLogo,
    onError: e => {
      if (!e.currentTarget.dataset.retried) {
        e.currentTarget.dataset.retried = "1";
        e.currentTarget.src = notebookLMLogoRemote;
      }
    },
    ...
    onError: e => {
      if (!e.currentTarget.dataset.retried) {
        e.currentTarget.dataset.retried = "1";
        e.currentTarget.src = meikoLogoRemote;
      }
    },
    alt: "Meiko Logo",
  ...
  }, A('Meiko微課頻道', 'Meiko Micro-Learning Channel')), /*#__PURE__*/React.createElement("span", {
    className: "mx-2 text-slate-600"
  }, "|"), /*#__PURE__*/React.createElement("span", {
    className: "text-pink-300 uppercase"
  }, "Presentation Assistant")))), /*#__PURE__*/React.createElement("div", {
    ...
    value: "ko"
  }, "\uD55C\uAD6D\uC5B4")), /*#__PURE__*/React.createElement("div", {
    className: "pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-slate-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "ArrowDown",
    size: 14
  }))))), /*#__PURE__*/React.createElement("div", {
    className: "sticky top-0 z-40 bg-black/90 backdrop-blur-md"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center py-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex bg-slate-900/95 p-1.5 rounded-xl border border-slate-700 shadow-[0_8px_20px_rgba(0,0,0,0.5)] w-full sm:w-auto justify-center"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('generator'),
    className: `flex-1 sm:flex-none px-4 py-2.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${activeTab === 'generator' ? 'bg-pink-300 text-slate-900 shadow-md' : 'text-slate-400 hover:text-pink-300'}`
  }, t.tabGenerator), /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('style'),
    className: `flex-1 sm:flex-none px-4 py-2.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${activeTab === 'style' ? 'bg-pink-300 text-slate-900 shadow-md' : 'text-slate-400 hover:text-pink-300'}`
  }, t.tabStyle), /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('reference'),
    className: `flex-1 sm:flex-none px-4 py-2.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${activeTab === 'reference' ? 'bg-pink-300 text-slate-900 shadow-md' : 'text-slate-400 hover:text-pink-300'}`
  }, t.tabReference), /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('pdf'),
    className: `flex-1 sm:flex-none px-4 py-2.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${activeTab === 'pdf' ? 'bg-pink-300 text-slate-900 shadow-md' : 'text-slate-400 hover:text-pink-300'}`
  }, t.tabPdf))), /*#__PURE__*/React.createElement("div", {
    className: "h-px bg-slate-700/70"
  })), /*#__PURE__*/React.createElement("div", {
    className: "mt-5 mb-8 flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-[11px] md:text-xs font-bold tracking-wider"
  }, t.flowSteps.map((s, i) => {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      ...
      className: `w-4 h-4 rounded-full border flex items-center justify-center text-[9px] leading-none flex-shrink-0 ${active ? 'border-pink-300 text-pink-300' : 'border-slate-600 text-slate-500'}`
    }, i + 1), /*#__PURE__*/React.createElement("span", {
      className: active ? 'text-pink-300' : 'text-slate-500'
    }, s)));
  })), activeTab === 'generator' ? /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-6 animate-in"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg backdrop-blur-sm w-full transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-5 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-3 flex items-center gap-2"
  }, t.step1Title), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-4 gap-6 items-start"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
  }, t.pages), /*#__PURE__*/React.createElement("div", {
    className: "relative"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Layers",
    size: 16,
    ...
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2.5 pl-10 pr-3 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50",
    placeholder: t.phSlideCount
  }))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
    ...
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2.5 pl-10 pr-8 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50 appearance-none cursor-pointer"
  }, baseOpts.role.map((zhVal, idx) => /*#__PURE__*/React.createElement("option", {
    key: zhVal,
    value: zhVal
  }, opts.role[idx]))), /*#__PURE__*/React.createElement("div", {
    className: "pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-slate-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "ArrowDown",
    size: 14
  }))), roleType === '自訂角色' && /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: customRole,
    onChange: e => setCustomRole(e.target.value),
    className: "mt-2 w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all",
    ...
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2.5 pl-10 pr-8 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50 appearance-none cursor-pointer"
  }, baseOpts.context.map((zhVal, idx) => /*#__PURE__*/React.createElement("option", {
    key: zhVal,
    value: zhVal
  }, opts.context[idx]))), /*#__PURE__*/React.createElement("div", {
    className: "pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-slate-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "ArrowDown",
    size: 14
  }))), context === '自訂設定' && /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: customContext,
    ...
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
  }, t.audience), /*#__PURE__*/React.createElement("div", {
    className: "relative"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Network",
    size: 16,
    ...
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2.5 pl-10 pr-8 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50 appearance-none cursor-pointer"
  }, baseOpts.audience.map((zhVal, idx) => /*#__PURE__*/React.createElement("option", {
    key: zhVal,
    value: zhVal
  }, opts.audience[idx]))), /*#__PURE__*/React.createElement("div", {
    className: "pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-slate-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "ArrowDown",
    size: 14
  }))), targetAudience === '自訂設定' && /*#__PURE__*/React.createElement("input", {
    type: "text",
    ...
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
  }, t.tone), /*#__PURE__*/React.createElement("div", {
    className: "relative"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Smile",
    size: 16,
    ...
    value: speakerTone,
    onChange: e => setSpeakerTone(e.target.value),
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2.5 pl-10 pr-8 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50 appearance-none cursor-pointer"
  }, baseOpts.tone.map((zhVal, idx) => /*#__PURE__*/React.createElement("option", {
    key: zhVal,
    value: zhVal
  }, opts.tone[idx]))), /*#__PURE__*/React.createElement("div", {
    className: "pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-slate-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "ArrowDown",
    size: 14
  }))), speakerTone === '自訂設定' && /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: customSpeakerTone,
    onChange: e => setCustomSpeakerTone(e.target.value),
    placeholder: t.phTone,
    className: "mt-2 w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
    ...
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-2.5 pl-10 pr-8 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50 appearance-none cursor-pointer"
  }, baseOpts.cta.map((zhVal, idx) => /*#__PURE__*/React.createElement("option", {
    key: zhVal,
    value: zhVal
  }, opts.cta[idx]))), /*#__PURE__*/React.createElement("div", {
    className: "pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-slate-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "ArrowDown",
    size: 14
  }))), callToAction === '自訂設定' && /*#__PURE__*/React.createElement("input", {
    type: "text",
    ...
    className: "flex bg-slate-900/80 p-1.5 rounded-xl border border-slate-700 shadow-inner"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setIncludeSpeakerNotes('yes'),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${includeSpeakerNotes === 'yes' ? 'bg-pink-400 text-slate-900 shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.need), /*#__PURE__*/React.createElement("button", {
    onClick: () => setIncludeSpeakerNotes('no'),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${includeSpeakerNotes === 'no' ? 'bg-slate-700 text-white shadow-md border border-slate-600' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.noNeed))), /*#__PURE__*/React.createElement("div", {
    className: "md:col-span-2"
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
  }, t.addition), /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-full min-h-[42px] bg-slate-900/60 border border-slate-600 rounded-lg py-2 pl-10 pr-3 text-white text-sm focus:border-pink-300 outline-none transition-all focus:ring-1 focus:ring-pink-300/50",
    placeholder: t.phAddition
  })))))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 lg:grid-cols-2 gap-6 items-start"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-5 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-4 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-2 flex items-center gap-2"
  }, t.step2Title), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, needCategories.map(c => /*#__PURE__*/React.createElement("button", {
    key: c.id,
    ...
    className: needType === c.id ? 'text-pink-300' : 'text-slate-500'
  }, /*#__PURE__*/React.createElement(Icon, {
    name: c.icon,
    size: 18
  })), /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-sm"
  }, c.label[language])))), /*#__PURE__*/React.createElement("button", {
    ...
    className: needType === 'custom' ? 'text-pink-300' : 'text-slate-500'
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Pen",
    size: 18
  })), /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-sm"
  }, t.customPurpose))), needType === 'custom' && /*#__PURE__*/React.createElement("div", {
    className: "mt-3 p-3 bg-slate-900/50 rounded-xl border border-slate-700"
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: customNeedType,
    onChange: e => setCustomNeedType(e.target.value),
    placeholder: t.phCustomPurpose,
    className: "w-full bg-slate-800/80 border border-slate-600 rounded-lg py-2.5 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all"
  })))), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-5 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-4 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-2 flex items-center gap-2"
  }, t.step3Title), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: selectedLayout === l.id ? 'text-pink-300' : 'text-slate-500'
    }, /*#__PURE__*/React.createElement(Icon, {
      name: l.icon,
      size: 18
    })), /*#__PURE__*/React.createElement("span", {
      className: "font-bold text-sm pr-6"
    }, l.label[language])), isRec && /*#__PURE__*/React.createElement("div", {
      className: "absolute top-2.5 right-2 px-1.5 py-0.5 bg-pink-300 text-slate-900 text-[10px] font-black rounded uppercase shadow-sm"
    }, t.recommend));
  }), /*#__PURE__*/React.createElement("button", {
    ...
    className: selectedLayout === 'custom' ? 'text-pink-300' : 'text-slate-500'
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Pen",
    size: 18
  })), /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-sm"
  }, t.customLayout))), selectedLayout === 'custom' && /*#__PURE__*/React.createElement("div", {
    className: "mt-3 space-y-3 bg-slate-900/50 p-3 rounded-xl border border-slate-700"
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: customLayoutName,
    onChange: e => setCustomLayoutName(e.target.value),
    placeholder: t.phLayoutName,
    className: "w-full bg-slate-800/80 border border-slate-600 rounded-lg py-2.5 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all"
  }), /*#__PURE__*/React.createElement("textarea", {
    value: customLayoutDesc,
    onChange: e => setCustomLayoutDesc(e.target.value),
    placeholder: t.phLayoutDesc,
    className: "w-full bg-slate-800/80 border border-slate-600 rounded-lg py-2.5 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all min-h-[60px] custom-scrollbar"
  })))))), /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-slate-800/80 border border-slate-600 p-6 rounded-2xl shadow-2xl flex flex-col relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-white font-black text-sm mb-6 flex items-center gap-2 uppercase tracking-wide"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Zap",
    size: 18,
    className: "text-pink-300"
  }), " ", t.outlinePromptTitle), /*#__PURE__*/React.createElement("div", {
    className: "space-y-4 w-full"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-950/60 p-4 rounded-xl border border-slate-700/80"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center mb-3 pb-2 border-b border-slate-800"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-slate-400 font-bold uppercase tracking-widest"
  }, promptHeaders[language]), /*#__PURE__*/React.createElement("button", {
    onClick: () => handleCopy(getPromptText(language).replace(/\{\{(.*?)\}\}/g, '$1'), 'copy-primary'),
    className: "bg-pink-300 hover:bg-pink-400 text-slate-900 text-sm font-bold flex items-center gap-1.5 px-3 py-1.5 rounded-md transition-colors shadow-sm active:scale-95"
  }, copiedType === 'copy-primary' ? /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 14
  }) : /*#__PURE__*/React.createElement(Icon, {
    name: "Copy",
    size: 14
  }), " ", copiedType === 'copy-primary' ? t.copied : t.copy)), /*#__PURE__*/React.createElement("p", {
    ...
    className: "text-xs text-slate-400 font-bold uppercase tracking-widest"
  }, promptHeaders['en']), /*#__PURE__*/React.createElement("button", {
    onClick: () => handleCopy(getPromptText('en').replace(/\{\{(.*?)\}\}/g, '$1'), 'copy-en'),
    className: "bg-pink-300 hover:bg-pink-400 text-slate-900 text-sm font-bold flex items-center gap-1.5 px-3 py-1.5 rounded-md transition-colors shadow-sm active:scale-95"
  }, copiedType === 'copy-en' ? /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 14
  }) : /*#__PURE__*/React.createElement(Icon, {
    name: "Copy",
    size: 14
  }), " ", copiedType === 'copy-en' ? "COPIED" : "COPY")), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-[15px] leading-relaxed font-mono whitespace-pre-wrap"
  }, /*#__PURE__*/React.createElement(HighlightedText, {
    text: getPromptText('en')
  })))), /*#__PURE__*/React.createElement("div", {
    className: "mt-5 flex flex-col sm:flex-row gap-4 flex-shrink-0"
  }, /*#__PURE__*/React.createElement("a", {
    href: "https://notebooklm.google.com/",
    target: "_blank",
    className: "flex-1 py-4 bg-slate-100 hover:bg-white text-slate-900 rounded-xl font-black text-sm flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95 text-center"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Sparkles",
    size: 18
  }), " ", t.goToNbLM), /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('style'),
    className: "flex-1 py-4 bg-pink-300 hover:bg-pink-400 text-slate-900 rounded-xl font-black text-sm flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95 text-center"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Wand2",
    size: 18
  }), " ", t.nextToStyle)))) : activeTab === 'style' ? /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-6 animate-in"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-5 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-3"
  }, t.pasteOutlineTitle), /*#__PURE__*/React.createElement("textarea", {
    value: pastedOutline,
    onChange: e => setPastedOutline(e.target.value),
    placeholder: t.phPasteOutline,
    className: "w-full bg-slate-900/60 border border-slate-600 rounded-lg py-3 px-4 text-white text-sm focus:border-pink-300 outline-none transition-all min-h-[180px] custom-scrollbar leading-relaxed"
  }), !pastedOutline.trim() && /*#__PURE__*/React.createElement("p", {
    className: "mt-2 text-xs text-amber-300/80 flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Info",
    size: 14
  }), " ", t.outlineEmptyHint)), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-5 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-3 flex items-center justify-between gap-3"
  }, /*#__PURE__*/React.createElement("span", null, t.styleSectionTitle), /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('reference'),
    className: "text-xs text-slate-400 hover:text-pink-300 font-bold tracking-normal transition-colors"
  }, t.viewTemplates)), /*#__PURE__*/React.createElement("div", {
    className: "mb-4 flex flex-col sm:flex-row gap-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full sm:max-w-xs"
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
  }, t.useStyleLabel), /*#__PURE__*/React.createElement("div", {
    className: "flex bg-slate-900/80 p-1.5 rounded-xl border border-slate-700 shadow-inner"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setNeedVisualStyle(true),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${needVisualStyle ? 'bg-pink-400 text-slate-900 shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.need), /*#__PURE__*/React.createElement("button", {
    onClick: () => setNeedVisualStyle(false),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${!needVisualStyle ? 'bg-slate-700 text-white shadow-md border border-slate-600' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.noNeed))), /*#__PURE__*/React.createElement("div", {
    className: `w-full sm:max-w-xs transition-all ${!needVisualStyle ? 'opacity-30 pointer-events-none' : ''}`
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "User",
    size: 14,
    className: "text-pink-300"
  }), " ", t.mainCharLabel), /*#__PURE__*/React.createElement("div", {
    className: "flex bg-slate-900/80 p-1.5 rounded-xl border border-slate-700 shadow-inner"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setUseMainCharacter(true),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${useMainCharacter ? 'bg-pink-400 text-slate-900 shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.need), /*#__PURE__*/React.createElement("button", {
    onClick: () => setUseMainCharacter(false),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${!useMainCharacter ? 'bg-slate-700 text-white shadow-md border border-slate-600' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.noNeed))), /*#__PURE__*/React.createElement("div", {
    className: "w-full sm:max-w-xs"
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block flex items-center gap-1.5"
    ...
    size: 14,
    className: "text-pink-300"
  }), " ", A('是否要留邊', 'Keep safe margins?')), /*#__PURE__*/React.createElement("div", {
    className: "flex bg-slate-900/80 p-1.5 rounded-xl border border-slate-700 shadow-inner"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setKeepMargins(true),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${keepMargins ? 'bg-pink-400 text-slate-900 shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.need), /*#__PURE__*/React.createElement("button", {
    onClick: () => setKeepMargins(false),
    className: `flex-1 py-2 text-sm font-bold rounded-lg transition-all ${!keepMargins ? 'bg-slate-700 text-white shadow-md border border-slate-600' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`
  }, t.noNeed)))), needVisualStyle && useMainCharacter && /*#__PURE__*/React.createElement("div", {
    className: "mb-4 bg-pink-300/10 border border-pink-300/20 p-3 rounded-xl flex items-start gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Info",
    size: 16,
    className: "text-pink-300 mt-0.5 flex-shrink-0"
  ...
  }, t.mainCharHint)), /*#__PURE__*/React.createElement("div", {
    className: `transition-all duration-300 ${!needVisualStyle ? 'opacity-30 pointer-events-none grayscale' : ''}`
  }, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("button", {
      key: d.id,
      onClick: () => handleStyleSelection(d.id),
      className: `text-left rounded-xl overflow-hidden border-2 transition-all group ${selectedStyle === d.id ? 'border-pink-300 shadow-[0_0_15px_rgba(249,168,212,0.3)]' : 'border-slate-700 hover:border-slate-500'}`
    }, /*#__PURE__*/React.createElement("div", {
      className: "aspect-video bg-slate-950/60 overflow-hidden relative"
    }, thumb && /*#__PURE__*/React.createElement("img", {
      src: getSlideAssetUrl(thumb),
      onError: e => {
        if (!e.currentTarget.dataset.retried) {
          e.currentTarget.dataset.retried = '1';
          e.currentTarget.src = thumb.replace('sz=w800', 'sz=w400');
        }
      },
      loading: "lazy",
      ...
      selected: selectedStyle === d.id
    })), /*#__PURE__*/React.createElement("div", {
      className: "p-2.5 bg-slate-900/60"
    }, /*#__PURE__*/React.createElement("div", {
      className: `text-xs font-bold ${selectedStyle === d.id ? 'text-pink-300' : 'text-slate-200'}`
    }, stylesTranslation[d.id]?.title[language] || d.title), /*#__PURE__*/React.createElement("div", {
      className: "text-[10px] text-slate-500 mt-0.5"
    }, stylesTranslation[d.id]?.category[language] || d.category)));
  }), /*#__PURE__*/React.createElement("button", {
    onClick: () => handleStyleSelection('strict-business'),
    className: `text-left rounded-xl overflow-hidden border-2 transition-all flex flex-col ${selectedStyle === 'strict-business' ? 'border-pink-300 shadow-[0_0_15px_rgba(249,168,212,0.3)]' : 'border-slate-700 hover:border-slate-500'}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "aspect-video bg-gradient-to-br from-[#16324F] via-[#244B6B] to-[#0D5689] flex items-center justify-center w-full relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-3 border border-white/20 rounded-lg"
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-[10px] font-black tracking-[0.18em] text-white"
  }, "STRICT BUSINESS")), /*#__PURE__*/React.createElement(CheckCircle, {
    selected: selectedStyle === 'strict-business'
  })), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 bg-slate-900/60 flex-grow w-full"
  }, /*#__PURE__*/React.createElement("div", {
    className: `text-xs font-bold ${selectedStyle === 'strict-business' ? 'text-pink-300' : 'text-slate-200'}`
  }, A('商務嚴格要求風格', 'Strict Business Style')), /*#__PURE__*/React.createElement("div", {
    className: "text-[10px] text-slate-500 mt-0.5"
  }, A('固定背景與標題規格', 'Fixed background and title specifications')))), /*#__PURE__*/React.createElement("button", {
    onClick: () => handleStyleSelection('custom'),
    className: `text-left rounded-xl overflow-hidden border-2 transition-all flex flex-col ${selectedStyle === 'custom' ? 'border-pink-300 shadow-[0_0_15px_rgba(249,168,212,0.3)]' : 'border-slate-700 hover:border-slate-500'}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "aspect-video bg-slate-900/80 flex items-center justify-center w-full relative"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Pen",
    size: 26,
    className: selectedStyle === 'custom' ? 'text-pink-300' : 'text-slate-500'
  }), /*#__PURE__*/React.createElement(CheckCircle, {
    selected: selectedStyle === 'custom'
  })), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 bg-slate-900/60 flex-grow w-full"
  }, /*#__PURE__*/React.createElement("div", {
    className: `text-xs font-bold ${selectedStyle === 'custom' ? 'text-pink-300' : 'text-slate-200'}`
  }, t.customStyle)))), selectedStyle === 'custom' && /*#__PURE__*/React.createElement("div", {
    className: "mt-4 space-y-3 bg-slate-900/50 p-4 rounded-xl border border-slate-700"
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: customStyleName,
    onChange: e => setCustomStyleName(e.target.value),
    placeholder: t.phStyleName,
    className: "w-full bg-slate-800/80 border border-slate-600 rounded-lg py-2.5 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all"
  }), /*#__PURE__*/React.createElement("textarea", {
    value: customStyleDesc,
    onChange: e => setCustomStyleDesc(e.target.value),
    placeholder: t.phStyleDesc,
    className: "w-full bg-slate-800/80 border border-slate-600 rounded-lg py-2.5 px-3 text-white text-sm focus:border-pink-300 outline-none transition-all min-h-[80px] custom-scrollbar"
  })))), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-5 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-3"
  }, t.paletteSectionTitle), /*#__PURE__*/React.createElement("div", {
    className: "mb-5"
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-2.5 block"
  }, A('投影片背景顏色', 'Slide background color')), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 sm:grid-cols-5 gap-2"
  }, [['white', A('白', 'White')], ['black', A('黑', 'Black')], ['ivory', A('米白', 'Ivory')], ['gray', A('淺灰', 'Light gray')], ['auto', A('自動配置', 'Automatic')]].map(([id, label]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    onClick: () => setBackgroundChoice(id),
    className: `py-2.5 px-2 rounded-lg border text-xs font-bold transition-all ${backgroundChoice === id ? 'bg-pink-300/15 border-pink-300 text-pink-300' : 'bg-slate-900/60 border-slate-700 text-slate-400 hover:border-slate-500'}`
  }, label))), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 mt-2"
  }, A('背景色會獨立寫入指令；「自動配置」會要求依內容與所選五色配色決定。', 'The background is written separately into the prompt. Automatic lets AI choose based on the content and selected five-color palette.'))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-3 gap-3"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => handlePaletteSelection('none'),
    className: `rounded-xl border-2 p-4 text-left transition-all flex items-center justify-center min-h-[110px] ${selectedPalette === 'none' ? 'border-pink-300 bg-pink-300/10 text-pink-300' : 'border-slate-700 bg-slate-900/40 text-slate-400 hover:border-slate-500'}`
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-sm"
  }, t.noPalette)), palettePresets.map(p => /*#__PURE__*/React.createElement("div", {
    key: p.id,
    className: `rounded-xl border-2 overflow-hidden transition-all ${selectedPalette === p.id ? 'border-pink-300 shadow-[0_0_15px_rgba(249,168,212,0.3)]' : 'border-slate-700 hover:border-slate-500'}`
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => handlePaletteSelection(p.id),
    className: "w-full text-left"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center px-3 py-2 bg-slate-900/60"
  }, /*#__PURE__*/React.createElement("span", {
    className: `text-xs font-bold ${selectedPalette === p.id ? 'text-pink-300' : 'text-slate-200'}`
  }, p.name)), /*#__PURE__*/React.createElement("div", {
    className: "flex h-14 relative"
  ...
  }, c.toUpperCase()))), /*#__PURE__*/React.createElement(CheckCircle, {
    selected: selectedPalette === p.id
  }))), /*#__PURE__*/React.createElement("button", {
    onClick: () => handleAddToCorp(p),
    className: "w-full py-1.5 bg-slate-900/80 text-[11px] font-bold text-slate-400 hover:text-pink-300 transition-colors flex items-center justify-center gap-1"
  }, addedPaletteId === p.id ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 12
  }), " ", t.added) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon, {
    name: "PlusCircle",
    size: 12
  }), " ", t.addToCorp)))))), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-5 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-3"
  }, "4. ", A('資料視覺化與表格', 'Data Visualization & Tables')), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 lg:grid-cols-5 gap-2 mb-5"
  }, [['none', A('不指定', 'Not specified')], ['auto', A('AI 自動判斷', 'Let AI decide')], ['charts', A('優先使用圖表', 'Prefer charts')], ['tables', A('優先使用表格', 'Prefer tables')], ['both', A('圖表與表格並用', 'Use charts & tables')]].map(([id, label]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    onClick: () => setDataVisualMode(id),
    className: `py-3 px-2 rounded-lg border text-xs font-bold transition-all ${dataVisualMode === id ? 'bg-pink-300/15 border-pink-300 text-pink-300' : 'bg-slate-900/60 border-slate-700 text-slate-400 hover:border-slate-500'}`
  }, label))), dataVisualMode !== 'none' && /*#__PURE__*/React.createElement("div", {
    className: "space-y-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid md:grid-cols-2 gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-bold text-slate-400 block mb-2"
  }, A('圖表密度', 'Chart density')), /*#__PURE__*/React.createElement("select", {
    value: chartDensity,
    onChange: e => setChartDensity(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-3 text-sm"
  }, /*#__PURE__*/React.createElement("option", {
    value: "low"
  }, A('少量，只在必要頁面使用', 'Low — only where necessary')), /*#__PURE__*/React.createElement("option", {
    value: "medium"
  }, A('適中，重要資料優先', 'Medium — prioritize key data')), /*#__PURE__*/React.createElement("option", {
    value: "high"
  }, A('大量，盡可能視覺化資料', 'High — visualize whenever possible')))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-bold text-slate-400 block mb-2"
  }, A('圖表類型', 'Chart types')), /*#__PURE__*/React.createElement("select", {
    value: chartTypeMode,
    onChange: e => setChartTypeMode(e.target.value),
    className: "w-full bg-slate-900 border border-slate-600 rounded-lg p-3 text-sm"
  }, /*#__PURE__*/React.createElement("option", {
    value: "auto"
  }, A('由 AI 選擇合適類型', 'Let AI choose the best type')), /*#__PURE__*/React.createElement("option", {
    value: "basic"
  }, A('僅使用基本圖表與表格', 'Basic charts and tables only'))))), /*#__PURE__*/React.createElement("div", {
    className: "grid sm:grid-cols-3 gap-3"
  }, [[showChartValues, setShowChartValues, A('顯示重要數值標籤', 'Show key value labels')], [showDataSource, setShowDataSource, A('有資料時標示來源', 'Show source when available')], [preserveDataUnits, setPreserveDataUnits, A('保留原始單位與精度', 'Preserve units and precision')]].map(([value, setter, label]) => /*#__PURE__*/React.createElement("button", {
    key: label,
    onClick: () => setter(!value),
    className: `py-3 px-3 rounded-lg border text-xs font-bold transition-all ${value ? 'bg-pink-300/15 border-pink-300 text-pink-300' : 'bg-slate-900/60 border-slate-700 text-slate-400'}`
  }, value ? '✓ ' : '', label))), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500"
  }, A('系統會禁止捏造數據，並依比較、趨勢、比例、精確數值或流程內容，自動選擇長條圖、折線圖、圓餅圖、表格或流程圖。', 'The system prevents fabricated data and selects bar, line, pie, table, or flowchart formats based on comparisons, trends, proportions, precise values, or processes.')))), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800/40 border border-slate-700/60 p-6 rounded-2xl shadow-lg backdrop-blur-sm transition-all hover:border-pink-300/30"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-sm font-black text-pink-300 mb-5 uppercase tracking-[0.2em] border-b border-slate-700/80 pb-3"
  }, t.corpSectionTitle), /*#__PURE__*/React.createElement("label", {
    className: "text-sm font-bold text-slate-300 mb-3 block"
  }, t.corpPalettesLabel), customPalettes.length === 0 && /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 mb-3"
  }, t.corpEmpty), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-3 gap-3 mb-3"
  }, customPalettes.map(p => /*#__PURE__*/React.createElement("div", {
    key: p.id,
    className: `rounded-xl border-2 overflow-hidden transition-all ${selectedPalette === p.id ? 'border-pink-300 shadow-[0_0_15px_rgba(249,168,212,0.3)]' : 'border-slate-700 hover:border-slate-500'}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2 px-3 py-2 bg-slate-900/60"
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: p.name,
    onChange: e => updateCustomPaletteName(p.id, e.target.value),
    placeholder: t.phPaletteName,
    className: "flex-grow min-w-0 bg-transparent border-b border-slate-700 focus:border-pink-300 text-xs font-bold text-slate-200 py-1 outline-none transition-all"
  }), /*#__PURE__*/React.createElement("button", {
    onClick: () => removeCustomPalette(p.id),
    className: "flex-shrink-0 text-[10px] font-bold text-slate-500 hover:text-red-400 transition-colors"
  }, t.deletePalette)), /*#__PURE__*/React.createElement("div", {
    className: "flex h-16 relative"
  }, p.colors.map((c, i) => {
    const isEditing = editingColor && editingColor.pid === p.id && editingColor.idx === i;
    return /*#__PURE__*/React.createElement("button", {
      key: i,
      onClick: () => setEditingColor(isEditing ? null : {
        pid: p.id,
        idx: i
      }),
    ...
    selected: selectedPalette === p.id,
    onClick: () => handlePaletteSelection(p.id)
  })), editingColor && editingColor.pid === p.id && /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-slate-900/90 border-t border-slate-700 flex justify-center"
    ...
    onClick: () => addCustomPalette(null),
    className: "rounded-xl border-2 border-dashed border-slate-700 hover:border-pink-300 text-slate-500 hover:text-pink-300 transition-all min-h-[100px] flex flex-col items-center justify-center gap-2 text-sm font-bold"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "PlusCircle",
    size: 20
  }), " ", t.addPalette))), /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-slate-800/80 border border-slate-600 p-6 rounded-2xl shadow-2xl flex flex-col relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-white font-black text-sm mb-6 flex items-center gap-2 uppercase tracking-wide"
  }, /*#__PURE__*/React.createElement(Icon, {
    ...
    size: 18,
    className: "text-pink-300"
  }), " ", t.finalOutputTitle), /*#__PURE__*/React.createElement("div", {
    className: "space-y-4 w-full"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-950/60 p-4 rounded-xl border border-slate-700/80"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => handleCopy(getFinalPromptText(language), 'copy-final'),
    className: "bg-pink-300 hover:bg-pink-400 text-slate-900 text-sm font-bold flex items-center gap-1.5 px-3 py-1.5 rounded-md transition-colors shadow-sm active:scale-95"
  }, copiedType === 'copy-final' ? /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 14
  }) : /*#__PURE__*/React.createElement(Icon, {
    name: "Copy",
    size: 14
  }), " ", copiedType === 'copy-final' ? t.copied : t.copy)), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-200 text-[15px] leading-relaxed whitespace-pre-wrap"
  }, renderFinalPrompt(getFinalPromptText(language))))), /*#__PURE__*/React.createElement("div", {
    className: "mt-5 flex flex-col sm:flex-row gap-4 flex-shrink-0"
  }, /*#__PURE__*/React.createElement("a", {
    href: "https://notebooklm.google.com/",
    target: "_blank",
    ...
    name: "Sparkles",
    size: 18
  }), " ", t.goToNbLM)))) : activeTab === 'pdf' ? /*#__PURE__*/React.createElement(PdfTools, {
    language: language
  }) : /*#__PURE__*/React.createElement("div", {
    className: "animate-in pb-10"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap justify-center gap-3 mb-8 max-w-5xl mx-auto"
  }, referenceData.filter(d => d.generatorShow !== false).map(d => /*#__PURE__*/React.createElement("button", {
    key: d.id,
    ...
    name: d.icon,
    size: 16,
    className: `flex-shrink-0 ${refStyle === d.id ? 'text-slate-900' : 'text-slate-500'}`
  }), /*#__PURE__*/React.createElement("span", null, stylesTranslation[d.id]?.title[language] || d.title.split(' (')[0])))), /*#__PURE__*/React.createElement("div", {
    className: "max-w-5xl mx-auto bg-slate-800/60 border border-slate-700 rounded-2xl p-6 md:p-10 shadow-2xl backdrop-blur-md"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mb-6 border-l-4 border-pink-300 pl-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-3xl font-black text-white tracking-tight uppercase italic flex items-center gap-3"
  }, stylesTranslation[activeRefStyle.id]?.title[language] || activeRefStyle.title.split(' (')[0])), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap items-center gap-3 flex-shrink-0"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-slate-400 font-bold uppercase tracking-widest bg-slate-950/60 px-4 py-1.5 rounded-full border border-slate-700"
  }, stylesTranslation[activeRefStyle.id]?.category[language] || activeRefStyle.category), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      handleStyleSelection(activeRefStyle.id);
      setNeedVisualStyle(true);
      setActiveTab('style');
    },
    className: "text-xs font-black uppercase tracking-widest bg-pink-300 hover:bg-pink-400 text-slate-900 px-4 py-1.5 rounded-full transition-all active:scale-95 flex items-center gap-1.5 shadow-md"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "PlusCircle",
    size: 14
  }), " ", t.addStyleFromRef))), activeRefStyle.examples && /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-2 mb-6"
  }, activeRefStyle.examples.map((ex, idx) => /*#__PURE__*/React.createElement("button", {
    key: idx,
  ...
  }, ex.name))), currentExample && currentExample.slides ? /*#__PURE__*/React.createElement("div", {
    className: "relative mb-10 bg-slate-900/80 p-5 rounded-2xl border border-slate-700/80 shadow-inner"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col md:flex-row gap-4 lg:gap-5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex-grow flex flex-col min-w-0"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-slate-950/40 rounded-xl border border-slate-700/50 overflow-hidden relative shadow-lg aspect-video"
  }, currentExample.slides.map((slide, idx) => /*#__PURE__*/React.createElement("img", {
    key: idx,
    src: getSlideAssetUrl(slide),
    onError: e => {
      if (!e.currentTarget.dataset.retried) {
        e.currentTarget.dataset.retried = "1";
        e.currentTarget.src = slide;
      }
    },
    ...
    className: "text-right mt-2 pr-1 text-[11px] md:text-xs font-bold text-white tracking-wider"
  }, t.provider, currentExample.provider || 'Meiko')), /*#__PURE__*/React.createElement("div", {
    className: "w-full md:w-36 lg:w-40 flex-shrink-0 relative"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-row md:flex-col gap-3 overflow-x-auto md:overflow-y-auto custom-scrollbar md:pr-2 py-1 md:absolute md:inset-0 h-[100px] md:h-auto"
  }, currentExample.slides.map((slide, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    ...
    onError: e => {
      if (!e.currentTarget.dataset.retried) {
        e.currentTarget.dataset.retried = '1';
        e.currentTarget.src = slide.replace('sz=w800', 'sz=w200');
      }
    },
    loading: "lazy",
    className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-500",
    ...
    className: "absolute top-1.5 left-1.5 bg-black/70 text-white text-[10px] px-2 py-0.5 rounded font-mono shadow-sm"
  }, "P.", idx + 1))))))) : /*#__PURE__*/React.createElement("div", {
    className: "relative mb-10 flex flex-col"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center mb-3"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setIsZoomed(!isZoomed),
    className: "flex items-center gap-2 text-xs font-black text-pink-300/60 uppercase tracking-widest hover:text-pink-300 transition-all"
  }, isZoomed ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon, {
    name: "ZoomOut",
    size: 14
  }), " ", t.zoomOut) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon, {
    name: "ZoomIn",
    size: 14
  }), " ", t.zoomIn))), /*#__PURE__*/React.createElement("div", {
    onClick: () => setIsZoomed(!isZoomed),
    className: `relative cursor-pointer transition-all duration-700 bg-slate-950/40 rounded-2xl overflow-hidden border border-slate-700/50 aspect-video ${isZoomed ? 'scale-110 shadow-2xl z-40 border-pink-300/30' : 'shadow-lg hover:border-pink-300/20'}`
  }, /*#__PURE__*/React.createElement("img", {
    src: currentExample ? currentExample.img : activeRefStyle.img,
    className: `w-full h-full object-cover transition-all duration-700 ${isZoomed ? 'opacity-100' : 'opacity-80'}`,
    alt: "preview"
  })), /*#__PURE__*/React.createElement("div", {
    className: "text-right mt-2 pr-1 text-[11px] md:text-xs font-bold text-white tracking-wider"
  }, t.provider, currentExample?.provider || activeRefStyle.provider || 'Meiko')), /*#__PURE__*/React.createElement("div", {
    className: "bg-pink-300/10 border border-pink-300/20 p-5 md:p-6 rounded-xl mb-10"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "text-pink-300 font-black uppercase text-xs tracking-[0.2em] mb-3 pb-2 border-b border-pink-300/20"
  }, t.styleInsight), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-200 text-sm md:text-base leading-relaxed font-light"
  }, activeRefStyle.description)), /*#__PURE__*/React.createElement("div", {
    className: "space-y-6 md:space-y-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-4"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "text-lg md:text-xl font-black text-white italic tracking-tight uppercase"
  }, t.stylePromptTitle), /*#__PURE__*/React.createElement("div", {
    className: "flex-grow h-px bg-slate-700"
  })), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-950/80 p-6 md:p-8 rounded-2xl border border-slate-700 space-y-6 md:space-y-8 shadow-inner"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, promptHeaders[language])), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-200 text-[15px] leading-relaxed whitespace-pre-wrap"
  }, /*#__PURE__*/React.createElement(HighlightedText, {
    text: activeRefStyle[`${language}Prompt`] || activeRefStyle.zhPrompt
  }))), /*#__PURE__*/React.createElement("div", {
  ...
  }, t.enPromptHeading)), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-[15px] leading-relaxed font-mono whitespace-pre-wrap"
  }, /*#__PURE__*/React.createElement(HighlightedText, {
    text: activeRefStyle.enPrompt
  })))), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col sm:flex-row gap-3 md:gap-4 pt-4"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => handleCopy(`${activeRefStyle[`${language}Prompt`] || activeRefStyle.zhPrompt}\n\n${activeRefStyle.enPrompt}`, 'ref-copy'),
    className: `flex-1 py-3.5 rounded-xl font-black text-sm transition-all active:scale-95 flex items-center justify-center gap-2 ${copiedType === 'ref-copy' ? 'bg-pink-400 text-slate-900 shadow-lg' : 'bg-slate-100 text-slate-900 hover:bg-white'}`
  }, copiedType === 'ref-copy' ? /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 18
  }) : /*#__PURE__*/React.createElement(Icon, {
    name: "Copy",
    size: 18
  }), copiedType === 'ref-copy' ? t.copied : t.copyStylePrompt), /*#__PURE__*/React.createElement("a", {
    href: "https://notebooklm.google.com/",
    target: "_blank",
    ...
    name: "Sparkles",
    size: 18
  }), " ", t.openNbLM)), /*#__PURE__*/React.createElement("div", {
    className: "mt-4 md:mt-6 bg-slate-900/60 border border-slate-700/80 p-4 rounded-xl flex items-start gap-3 shadow-inner"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Info",
    size: 18,
    className: "text-pink-300 mt-0.5 flex-shrink-0"
  ...
  }, t.welcomeShare, /*#__PURE__*/React.createElement("a", {
    href: "mailto:meikoedux@gmail.com",
    className: "text-pink-300 hover:text-pink-400 transition-colors underline underline-offset-2"
  }, "meikoedux@gmail.com"), ")"))), /*#__PURE__*/React.createElement("div", {
    className: "mt-10 md:mt-14 pt-6 md:pt-8 border-t border-slate-700 flex justify-center"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveTab('generator'),
    className: "text-slate-500 hover:text-pink-300 text-sm font-bold flex items-center gap-2 tracking-[0.3em] transition-all"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "Wand2",
    size: 18
  }), " ", t.backToGen))))), /*#__PURE__*/React.createElement("footer", {
    className: "w-full mt-10 pt-10 pb-12 border-t border-slate-800/50 bg-black/60 backdrop-blur-md"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    href: "https://www.youtube.com/@meiko1",
    target: "_blank",
    className: "bg-[#FF0000] hover:bg-[#CC0000] text-white text-xs font-bold px-8 py-3.5 rounded-full transition-all shadow-md flex items-center gap-2 w-fit"
    ...
    className: "text-xs font-black text-slate-400 mb-1.5 uppercase tracking-widest"
  }, "\xA9 2026 Meiko \u5FAE\u8AB2\u983B\u9053 | Gemini Notebook Presentation Lab"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500"
  }, t.footerLabel, " ", /*#__PURE__*/React.createElement("a", {
    href: "https://www.youtube.com/@meiko1",
    target: "_blank",
    className: "text-pink-300 font-bold underline hover:text-pink-400"
  }, "\u3010Meiko\u5FAE\u8AB2\u983B\u9053\u3011")), totalViews !== null && /*#__PURE__*/React.createElement("div", {
    className: "mt-5 flex justify-center md:justify-end"
  }, /*#__PURE__*/React.createElement("div", {
    className: "inline-flex items-center rounded-full border border-slate-600/80 bg-slate-950/80 px-4 py-2 text-[11px] md:text-xs font-bold text-slate-300"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-pink-300 mr-1.5"
  }, "\u25C9"), A('累積瀏覽次數', 'Total views', '累計閲覧数', '누적 조회수'), " ", totalViews.toLocaleString(language === 'zh' ? 'zh-TW' : language))))), /*#__PURE__*/React.createElement("div", {
    className: "h-[3px] bg-slate-900 w-full rounded-full overflow-hidden opacity-40"
  }, /*#__PURE__*/React.createElement("div", {
    className: `h-full ${accentBg} w-1/3`
  })))));
};
