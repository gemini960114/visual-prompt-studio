...
- **直接 AI 生圖**：支援直接在介面上微調編輯，並有一鍵單獨複製底部的 Midjourney / Flux / Gemini 英文提示詞，帶有精確解析度、色彩十六進位碼與構圖關鍵詞，直接生成一致性極高的系列作品。
...
- **AI 繪圖提示詞 (Full Prompt)**：產生分層嚴謹的 Midjourney / Flux / Gemini 提示詞，支援介面即時編輯與獨立複製。
