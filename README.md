...
- **一鍵直接複製提示詞**：點擊「📋 複製提示詞」，直接貼到 Google Gemini、Claude 或 ChatGPT 對話框發送，AI 即會嚴格依照此規格與色票完成高水準的海報視覺規劃、文案擴寫或圖像生成！
...
- **結構化提示詞**：標準 Markdown 結構規格書，相容 Gemini / Claude / ChatGPT。
- **企劃文稿匯出**：支援一鍵匯出 `.md` Markdown 結構化企劃文稿，方便存入 Notion 或 Obsidian 知識庫。
